...
---
# <a name="run-and-print-reports-in-business-central"></a>Run and Print Reports
...
## <a name="use-default-valuesmdashpredefined-settings"></a><a name="SavedSettings"></a>Using default values&mdash;predefined settings
...
## <a name="specify-the-data-to-include-in-a-report"></a>Specifying the data to include in a report
...
## <a name="preview-a-report"></a>Previewing a report
...
## <a name="save-a-report-to-a-file"></a>Saving a report to a file
...
## <a name="schedule-a-report-to-run-later-or-periodically"></a><a name="ScheduleReport"></a>Scheduling a report to run later or periodically
...
## <a name="print-a-report"></a><a name="PrintReport"></a>Printing a report
...
### <a name="print-reports-in-thai"></a>Printing reports in Thai
...
## <a name="switch-the-report-layout"></a>Switching the report layout
