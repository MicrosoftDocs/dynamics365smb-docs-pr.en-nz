...
# <a name="run-and-print-reports-in-business-central"></a>Run and print reports in Business Central
...
## <a name="use-default-valuesmdashpredefined-settings"></a><a name="SavedSettings"></a>Use default values&mdash;predefined settings
...
## <a name="specify-the-data-to-include-in-a-report"></a>Specify the data to include in a report
...
## <a name="preview-a-report"></a>Preview a report
...
## <a name="save-a-report-to-a-file"></a>Save a report to a file
...
## <a name="schedule-a-report-to-run-later-or-periodically"></a><a name="ScheduleReport"></a>Schedule a report to run later or periodically
...
## <a name="print-a-report"></a><a name="PrintReport"></a>Print a report
...
### <a name="print-reports-in-thai"></a>Print reports in Thai
...
## <a name="switch-the-report-layout"></a>Switch the report layout
