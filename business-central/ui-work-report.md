...
ms.author: jswymer
---
# <a name="run-and-print-reports"></a><a name="run-and-print-reports"></a>Run and Print Reports
...
## <a name="using-default-valuesmdashpredefined-settings"></a><a name="using-default-valuesmdashpredefined-settings"></a><a name="SavedSettings"></a>Using default values&mdash;predefined settings
...
## <a name="specifying-the-data-to-include-in-a-report"></a><a name="specifying-the-data-to-include-in-a-report"></a>Specifying the data to include in a report
...
## <a name="previewing-a-report"></a><a name="previewing-a-report"></a>Previewing a report
...
### <a name="work-with-the-preview"></a><a name="work-with-the-preview"></a>Work with the preview
...
## <a name="saving-a-report-to-a-file"></a><a name="saving-a-report-to-a-file"></a>Saving a report to a file
...
## <a name="scheduling-a-report-to-run-later-or-periodically"></a><a name="scheduling-a-report-to-run-later-or-periodically"></a><a name="ScheduleReport"></a> Scheduling a report to run later or periodically
...
### <a name="manage-scheduled-recurring-reports"></a><a name="manage-scheduled-recurring-reports"></a>Manage scheduled recurring reports
...
## <a name="printing-a-report"></a><a name="printing-a-report"></a><a name="PrintReport"></a>Printing a report
...
### <a name="printing-reports-in-thai"></a><a name="printing-reports-in-thai"></a>Printing reports in Thai
...
## <a name="switching-the-report-layout"></a><a name="switching-the-report-layout"></a>Switching the report layout
...
## <a name="change-language-and-format-of-numbers-dates-and-times"></a><a name="change-language-and-format-of-numbers-dates-and-times"></a>Change language and format of numbers, dates, and times
...
## <a name="advanced-options"></a><a name="advanced-options"></a>Advanced options
