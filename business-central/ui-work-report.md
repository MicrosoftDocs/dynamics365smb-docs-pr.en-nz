...
ms.author: jswymer
---
# <a name="run-and-print-reports" />Run and Print Reports
...
## <a name="specifying-the-data-to-include-in-a-report" />Specifying the data to include in a report
...
## <a name="previewing-a-report" />Previewing a report
...
### <a name="work-with-the-preview" />Work with the preview
...
## <a name="saving-a-report-to-a-file" />Saving a report to a file
...
### <a name="manage-scheduled-recurring-reports" />Manage scheduled recurring reports
...
### <a name="printing-reports-in-thai" />Printing reports in Thai
...
## <a name="switching-the-report-layout" />Switching the report layout
...
## <a name="change-language-and-format-of-numbers-dates-and-times" />Change language and format of numbers, dates, and times
...
## <a name="advanced-options" />Advanced options
