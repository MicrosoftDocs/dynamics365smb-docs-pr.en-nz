...
## <a name="declining-balance-1-depreciation"></a><a name="declining-balance-1-depreciation"></a>Declining-Balance 1 Depreciation
...
### <a name="example---declining-balance-1-depreciation"></a><a name="example---declining-balance-1-depreciation"></a>Example - Declining-Balance 1 Depreciation
...
## <a name="declining-balance-2-depreciation"></a><a name="declining-balance-2-depreciation"></a>Declining-Balance 2 Depreciation
...
### <a name="example---declining-balance-2-depreciation"></a><a name="example---declining-balance-2-depreciation"></a>Example - Declining-Balance 2 Depreciation
...
## <a name="db1sl-depreciation"></a><a name="db1sl-depreciation"></a>DB1/SL Depreciation
...
## <a name="example---db1sl-depreciation-using-half-year-convention"></a><a name="example---db1sl-depreciation-using-half-year-convention"></a>Example - DB1/SL Depreciation Using Half-Year Convention
