...
|To  |See  |
|---------|---------|
|To make it easier to manage permissions for multiple users, you can organise them in security groups and then assign or change one permission set for many users in one action.| [Manage permissions through user groups](#manage-permissions-through-user-groups) |
...
## <a name="create-a-permission-set"></a>Create a permission set
...
## <a name="copy-a-permission-set"></a>Copy a permission set
...
## <a name="create-or-modify-permissions-by-recording-your-actions"></a>Create or modify permissions by recording your actions
...
## <a name="remove-obsolete-permissions-from-all-permission-sets"></a>Remove obsolete permissions from all permission sets

On the **Permission Sets** page, choose the **Remove Obsolete Permissions** action.

## <a name="set-up-time-constraints-for-users"></a>Set up time constraints for users
...
## <a name="control-access-to-specific-companies"></a>Control access to specific companies
...
## <a name="manage-permissions-through-user-groups"></a>Manage permissions through user groups
...
## <a name="assign-permission-sets-to-users"></a>Assign permission sets to users
...
A [!INCLUDE[prod_short](includes/prod_short.md)] solution contains predefined permission sets that are added by Microsoft or by your solution provider. You can also add new permission sets tailored to meet the needs of your organisation. For more information, see the [Create a permission set](#create-a-permission-set) section.
...
## <a name="get-an-overview-of-a-users-permissions"></a>Get an overview of a user's permissions
...
## <a name="view-permission-changes-telemetry"></a>View permission changes telemetry
