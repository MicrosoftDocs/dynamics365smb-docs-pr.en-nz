...
## <a name="edit-a-profile"></a>Edit a profile
...
## <a name="assign-a-profile-to-a-user"></a>Assign a profile to a user
...
## <a name="define-user-settings-for-a-profile"></a>Define user settings for a profile
...
## <a name="activate-a-profile"></a>Activate a profile
...
## <a name="export-profiles"></a>Export profiles
...
## <a name="import-profiles"></a>Import profiles
...
## <a name="delete-personalizations"></a>Delete personalizations

### <a name="delete-all-personalizations-made-by-a-specific-user"></a>Delete all personalizations made by a specific user
...
### <a name="delete-personalizations-for-specific-pages"></a>Delete personalizations for specific pages
