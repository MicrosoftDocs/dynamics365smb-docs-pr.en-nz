...
ms.search.form: 9171
---
# <a name="manage-user-profiles"></a><a name="manage-user-profiles"></a><a name="manage-user-profiles"></a>Manage User Profiles
...
## <a name="page-customization"></a><a name="page-customization"></a><a name="page-customization"></a>Page Customisation
...
## <a name="to-create-a-profile"></a><a name="to-create-a-profile"></a><a name="to-create-a-profile"></a>To create a profile
...
## <a name="to-copy-a-profile"></a><a name="to-copy-a-profile"></a><a name="to-copy-a-profile"></a>To copy a profile
...
## <a name="to-edit-a-profile"></a><a name="to-edit-a-profile"></a><a name="to-edit-a-profile"></a>To edit a profile
...
## <a name="to-assign-a-profile-to-a-user"></a><a name="to-assign-a-profile-to-a-user"></a><a name="to-assign-a-profile-to-a-user"></a>To assign a profile to a user
...
## <a name="to-define-user-settings-for-a-profile"></a><a name="to-define-user-settings-for-a-profile"></a><a name="to-define-user-settings-for-a-profile"></a>To define user settings for a profile
...
## <a name="to-activate-a-profile"></a><a name="to-activate-a-profile"></a><a name="to-activate-a-profile"></a>To activate a profile
...
## <a name="to-export-profiles"></a><a name="to-export-profiles"></a><a name="to-export-profiles"></a>To export profiles
...
## <a name="to-import-profiles"></a><a name="to-import-profiles"></a><a name="to-import-profiles"></a>To import profiles
...
## <a name="to-delete-a-profile"></a><a name="to-delete-a-profile"></a><a name="to-delete-a-profile"></a>To delete a profile
...
## <a name="to-delete-all-personalizations-made-by-a-user"></a><a name="to-delete-all-personalizations-made-by-a-user"></a><a name="to-delete-all-personalizations-made-by-a-user"></a>To delete all personalisations made by a user
...
## <a name="to-delete-personalizations-for-specific-pages"></a><a name="to-delete-personalizations-for-specific-pages"></a><a name="to-delete-personalizations-for-specific-pages"></a>To delete personalisations for specific pages
...
## <a name="managing-user-sessions"></a><a name="managing-user-sessions"></a><a name="managing-user-sessions"></a>Managing user sessions
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>See related [Microsoft training](/training/modules/users-security-dynamics-365-business-central/)
