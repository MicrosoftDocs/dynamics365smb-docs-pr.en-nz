...
ms.author: edupont
---
# <a name="legacy-import-and-export-custom-report-layouts" />(Legacy) Import and Export Custom Report Layouts
...
### <a name="to-export-a-report-layout-to-a-file" />To export a report layout to a file
...
### <a name="to-import-a-report-layout-file" />To import a report layout file
