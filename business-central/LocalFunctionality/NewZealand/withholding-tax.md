...
ms.author: bholtorf
---
# <a name="withholding-tax-in-the-new-zealand-version" />Withholding Tax in the New Zealand Version
...
## <a name="wht-for-suppliers-without-an-ird" />WHT for Suppliers Without an IRD
...
## <a name="wht-for-foreign-suppliers" />WHT for Foreign Suppliers
