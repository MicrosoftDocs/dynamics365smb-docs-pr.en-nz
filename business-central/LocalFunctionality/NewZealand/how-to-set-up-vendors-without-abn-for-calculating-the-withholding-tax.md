...
ms.author: bholtorf
---
# <a name="set-up-vendors-without-ird-numbers-for-calculating-the-withholding-tax"></a><a name="set-up-vendors-without-ird-numbers-for-calculating-the-withholding-tax"></a>Set Up Vendors Without IRD numbers for Calculating the Withholding Tax
...
## <a name="to-set-up-vendors-without-ird-for-calculating-the-withholding-tax"></a><a name="to-set-up-vendors-without-ird-for-calculating-the-withholding-tax"></a>To set up vendors without IRD for calculating the withholding tax
