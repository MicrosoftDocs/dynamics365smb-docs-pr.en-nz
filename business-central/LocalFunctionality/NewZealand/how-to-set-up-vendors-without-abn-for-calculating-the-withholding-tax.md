...
ms.author: bholtorf
---
# <a name="set-up-vendors-without-ird-numbers-for-calculating-the-withholding-tax" />Set Up Vendors Without IRD numbers for Calculating the Withholding Tax
...
## <a name="to-set-up-vendors-without-ird-for-calculating-the-withholding-tax" />To set up vendors without IRD for calculating the withholding tax
