...
ms.author: edupont
---
# <a name="set-up-withholding-tax-in-the-new-zealand-version"></a><a name="set-up-withholding-tax-in-the-new-zealand-version"></a>Set Up Withholding Tax in the New Zealand Version
