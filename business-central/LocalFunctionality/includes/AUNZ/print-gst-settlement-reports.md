...
## <a name="to-print-a-goods-and-service-tax-settlement"></a><a name="to-print-a-goods-and-service-tax-settlement"></a><a name="to-print-a-goods-and-service-tax-settlement"></a>To print a goods and service tax settlement
