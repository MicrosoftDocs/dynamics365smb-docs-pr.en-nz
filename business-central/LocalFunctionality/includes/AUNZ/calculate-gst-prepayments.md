...
## <a name="to-calculate-gst-on-prepayments"></a><a name="to-calculate-gst-on-prepayments"></a><a name="to-calculate-gst-on-prepayments"></a>To calculate GST on prepayments
