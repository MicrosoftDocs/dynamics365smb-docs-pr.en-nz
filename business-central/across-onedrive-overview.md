...
# <a name="business-central-and-onedrive-for-business-integration" />Business Central and OneDrive for Business Integration
...
## <a name="get-started-with-onedrive-features" />Get started with OneDrive features
...
### <a name="open-and-share-in-onedrive" />Open and share in OneDrive
...
### <a name="save-excel-workbooks-and-report-files-in-onedrive" />Save Excel workbooks and report files in OneDrive
