...
ms.author: edupont
---
# <a name="legacy-create-and-modify-custom-report-layouts"></a><a name="legacy-create-and-modify-custom-report-layouts"></a>(Legacy) Create and Modify Custom Report Layouts
...
## <a name="create-a-custom-layout"></a><a name="create-a-custom-layout"></a>Create a custom layout
...
## <a name="modifying-a-custom-layout"></a><a name="modifying-a-custom-layout"></a><a name="ModifyCustomLayout"></a>Modifying a custom layout
...
### <a name="modify-a-custom-layout"></a><a name="modify-a-custom-layout"></a>Modify a custom layout
