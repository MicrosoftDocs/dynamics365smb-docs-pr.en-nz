...
# <a name="walkthrough-make-cash-flow-forecasts-using-financial-reports"></a>Walkthrough: Make cash flow forecasts using financial reports
...
## <a name="assig-the-column-definition-to-the-financial-report-name"></a>Assig the column definition to the financial report name
