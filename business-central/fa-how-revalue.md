...
ms.author: edupont
---
# <a name="revalue-fixed-assets" />Revalue Fixed Assets
...
## <a name="to-post-an-appreciation-from-the-fixed-asset-gl-journal" />To post an appreciation from the fixed asset G/L journal
...
## <a name="to-post-a-write-down-from-the-fixed-asset-gl-journal" />To post a write-down from the fixed asset G/L journal
...
## <a name="to-perform-general-revaluation-of-fixed-assets" />To perform general revaluation of fixed assets
...
## <a name="to-post-additional-acquisition-costs" />To post additional acquisition costs
...
### <a name="example---posting-additional-acquisition-costs" />Example - Posting Additional Acquisition Costs
