...
## <a name="to-post-appreciation-from-the-fixed-asset-gl-journal"></a>To post an appreciation from the fixed asset G/L journal
...
## <a name="to-post-other-acquisition-costs"></a>To post additional acquisition costs
...
### <a name="example---posting-other-acquisition-costs"></a>Example - Posting Additional Acquisition Costs
