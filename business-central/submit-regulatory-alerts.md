...
ms.author: soalex
---
# <a name="submit-alerts-about-countryregion-specific-regulatory-features"></a><a name="submit-alerts-about-countryregion-specific-regulatory-features"></a><a name="submit-alerts-about-countryregion-specific-regulatory-features"></a>Submit Alerts about Country/Region-Specific Regulatory Features
...
## <a name="to-submit-a-regulatory-alert-in-lcs"></a><a name="to-submit-a-regulatory-alert-in-lcs"></a><a name="to-submit-a-regulatory-alert-in-lcs"></a>To submit a regulatory alert in LCS
