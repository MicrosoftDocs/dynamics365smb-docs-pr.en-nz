...
ms.author: bholtorf
---
# <a name="specify-when-and-how-to-receive-workflow-notifications" />Specify When and How to Receive Workflow Notifications
...
## <a name="steps-in-workflows" />Steps in workflows
...
## <a name="specify-when-and-how-approval-users-receive-notifications" />Specify when and how approval users receive notifications
...
## <a name="change-when-and-how-you-receive-notifications" />Change when and how you receive notifications
