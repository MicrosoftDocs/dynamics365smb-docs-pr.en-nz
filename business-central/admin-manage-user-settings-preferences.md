...
ms.author: soalex
---
# <a name="manage-user-settings-and-preferences" />Manage user settings and preferences
...
## <a name="types-of-user-settings" />Types of user settings
...
## <a name="overview-of-all-user-specific-changes" />Overview of all user-specific changes
...
## <a name="to-review-or-delete-user-personalizations" />To review or delete user personalisations
