...
ms.author: soalex
---
# <a name="manage-user-settings-and-preferences"></a><a name="manage-user-settings-and-preferences"></a>Manage user settings and preferences
...
## <a name="types-of-user-settings"></a><a name="types-of-user-settings"></a>Types of user settings
...
## <a name="overview-of-all-user-specific-changes"></a><a name="overview-of-all-user-specific-changes"></a>Overview of all user-specific changes
...
## <a name="to-review-or-delete-user-personalizations"></a><a name="to-review-or-delete-user-personalizations"></a>To review or delete user personalisations
