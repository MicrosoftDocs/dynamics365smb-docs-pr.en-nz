...
To quickly locate features, select **Find**, then enter a word or phrase for the feature you're trying to find. The role centre highlights any matching text. If a feature is hidden in a collapsed node, the collapsed node is marked with a dot. 
