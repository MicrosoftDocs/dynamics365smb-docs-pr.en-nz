...
# <a name="finding-pages-with-the-role-explorer" />Finding Pages with the Role Explorer
...
## <a name="open-the-role-explorer" />Open the role explorer
...
## <a name="navigate-features" />Navigate features
...
## <a name="search-for-features" />Search for features
...
## <a name="explore-other-roles" />Explore other roles
...
## <a name="expand-and-collapse-nodes-on-the-role-explorer" />Expand and collapse nodes on the role explorer
