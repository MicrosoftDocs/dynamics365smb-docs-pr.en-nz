...
ms.author: edupont
---
# <a name="work-on-service-tasks" />Work on Service Tasks
...
## <a name="to-work-on-a-service-task" />To work on a service task
...
## <a name="to-register-service-operations" />To register service operations
...
## <a name="to-register-spare-parts" />To register spare parts
...
## <a name="to-register-spare-parts-from-a-service-order" />To register spare parts from a service order
...
## <a name="to-replace-a-service-item-or-a-service-item-component" />To replace a service item or a service item component
...
## <a name="to-change-the-response-time-for-a-service-item-line" />To change the response time for a service item line
...
## <a name="to-register-faultresolution-codes" />To register fault/resolution codes
