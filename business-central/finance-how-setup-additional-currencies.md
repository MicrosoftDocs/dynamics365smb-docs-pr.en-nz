...
3. If you post in an ACY, in the **GST Exchange Rate Adjustment** field you can specify how the accounts set up for GST posting on the **GST Posting Setup** page are adjusted for exchange-rate fluctuations between LCY and the ACY.  
    ...
    You have the same options as with general ledger entries but in this case the entries adjusted are the GST entries. The following table describes the options.
