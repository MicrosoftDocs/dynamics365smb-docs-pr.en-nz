...
# <a name="set-up-resource-allocation" />Set Up Resource Allocation
...
## <a name="to-set-up-skills" />To set up skills
...
## <a name="to-assign-skills-to-service-items-and-resources" />To assign skills to service items and resources
...
## <a name="to-set-up-zones" />To set up zones
...
## <a name="to-assign-zones-to-customers-and-resources" />To assign zones to customers and resources
...
## <a name="to-specify-what-to-show-when-a-resource-is-chosen" />To specify what to show when a resource is chosen
...
## <a name="to-update-resource-capacity" />To update resource capacity
...
## <a name="to-update-skills-for-items-service-items-or-service-item-groups" />To update skills for items, service items, or service item groups
