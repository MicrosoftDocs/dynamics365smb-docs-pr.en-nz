...
ms.author: edupont
---
# <a name="restructure-warehouses" />Restructure Warehouses
...
## <a name="to-restructure-a-basic-warehouse-that-uses-bins-only" />To restructure a basic warehouse that uses bins only
...
## <a name="to-restructure-an-advanced-warehouse-that-uses-directed-put-away-and-pick" />To restructure an advanced warehouse that uses directed put-away and pick
...
## <a name="to-delete-a-bin" />To delete a bin
...
## <a name="to-rename-a-bin-and-change-the-bin-code-in-all-records" />To rename a bin and change the bin code in all records
