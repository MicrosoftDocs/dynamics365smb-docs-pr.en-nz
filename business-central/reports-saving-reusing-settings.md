...
ms.author: edupont
---
# <a name="manage-saved-settings-for-reports-and-batch-jobs" />Manage Saved Settings for Reports and Batch jobs
...
## <a name="manage-saved-settings" />Manage saved settings
...
## <a name="create-or-modify-saved-settings-for-all-users" />Create or modify saved settings for all users
