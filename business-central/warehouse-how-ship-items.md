...
# <a name="ship-items-with-a-warehouse-shipment" />Ship Items with a Warehouse Shipment
...
## <a name="to-ship-items-using-a-warehouse-shipment-document" />To ship items using a warehouse shipment document
...
## <a name="handling-assemble-to-order-items-in-warehouse-shipments" />Handling Assemble-to-Order Items in Warehouse Shipments
