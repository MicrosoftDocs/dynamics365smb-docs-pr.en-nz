...
# <a name="troubleshoot-microsoft-teams-integration-with-"></a>Troubleshoot Microsoft Teams Integration with [!INCLUDE [prod_short](includes/prod_short.md)]
...
## <a name="unable-to-sign-in-to-the-share-to-teams-window"></a>Unable to sign in to the Share to Teams window
...
## <a name="others-see-a-different-sorting-or-column-layout-than-what-the-tab-author-sees"></a>Others see a different sorting or column layout than what the tab author sees
