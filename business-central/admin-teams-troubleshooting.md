...
# <a name="troubleshooting-microsoft-teams-integration-with-include-prodshortincludesprodshortmd" />Troubleshooting Microsoft Teams Integration with [!INCLUDE [prod_short](includes/prod_short.md)]
...
## <a name="the-sign-in-link-doesnt-work" />The sign-in link doesn't work
...
## <a name="the-settings-page-is-empty" />The Settings page is empty
...
## <a name="i-changed-company-but-it-didnt-seem-to-work" />I changed company but it didn't seem to work
...
## <a name="something-went-wrong-error-when-searching-for-contacts" />"Something went wrong" error when searching for contacts
...
## <a name="cannot-find-the-contactcontact-summary-api-error-when-searching-for-contacts" />"Cannot find the contact/contact summary API" error when searching for contacts
...
## <a name="none-of-my-links-expand-into-a-card" />None of my links expand into a card
...
## <a name="my-link-sometimes-doesnt-expand-into-a-card" />My link sometimes doesn’t expand into a card
...
## <a name="the-details-window-opens-but-shows-an-error-before-details-are-shown" />The details window opens, but shows an error before details are shown
...
## <a name="im-having-problems-with-the-camera-or-location-in-teams" />I'm having problems with the camera or location in Teams
...
## <a name="teams-displays-mixed-languages-for-my-cards-and-card-details" />Teams displays mixed languages for my cards and card details
...
## <a name="i-edited-a-field-in-the-details-window-but-my-change-wasnt-saved" />I edited a field in the details window, but my change wasn't saved
...
## <a name="a-new-tile-appeared-in-the-app-launcher-how-do-i-remove-it" />A new tile appeared in the App Launcher. How do I remove it?
...
## <a name="duplicate-text-in-the-share-to-teams-window" />Duplicate text in the Share to Teams window
...
## <a name="unable-to-sign-into-the-share-to-teams-window" />Unable to sign into the Share to Teams window
...
## <a name="my-cards-no-longer-have-a-popout-button" />My cards no longer have a popout button
...
## <a name="cant-pin-a-card-to-tab" />Can't pin a card to tab
...
## <a name="someone-added-a-tab-but-the-tab-doesnt-show-up-for-me" />Someone added a tab, but the tab doesn’t show up for me
...
## <a name="others-see-different-sorting-or-column-layout-than-what-the-tab-author-sees" />Others see different sorting or column layout than what the tab author sees
