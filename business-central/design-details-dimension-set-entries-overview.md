...
ms.author: edupont
---
# <a name="dimension-set-entries-overview"></a><a name="dimension-set-entries-overview"></a><a name="dimension-set-entries-overview"></a>Dimension Set Entries Overview
...
## <a name="dimension-set-entries"></a><a name="dimension-set-entries"></a><a name="dimension-set-entries"></a>Dimension Set Entries
...
## <a name="performance-improvement"></a><a name="performance-improvement"></a><a name="performance-improvement"></a>Performance Improvement
