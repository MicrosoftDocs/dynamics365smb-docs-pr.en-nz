...
# <a name="use-the-amc-banking-365-fundamentals-extension" />Use the AMC Banking 365 Fundamentals Extension
...
## <a name="use-our-demonstration-account" />Use our demonstration account
...
## <a name="setting-up-the-extension" />Setting up the extension
...
### <a name="to-set-up-the-required-permission-sets" />To set up the required permission sets
...
### <a name="to-connect-the-extension-to-amc-banking" />To connect the extension to AMC Banking
...
### <a name="to-connect-bank-accounts-to-the-extension" />To connect bank accounts to the extension
...
## <a name="use-the-extension" />Use the extension
...
### <a name="to-export-data-and-submit-it-to-your-bank" />To export data and submit it to your bank
...
### <a name="to-import-and-apply-the-converted-file" />To import and apply the converted file
