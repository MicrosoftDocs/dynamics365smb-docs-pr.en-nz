...
ms.author: edupont
---
# <a name="local-functionality-in-"></a><a name="local-functionality-in-"></a>Local Functionality in [!INCLUDE[prod_long](includes/prod_long.md)]
...
## <a name="local-functionality"></a><a name="local-functionality"></a>Local Functionality
...
### <a name="other-countries"></a><a name="other-countries"></a>Other Countries
