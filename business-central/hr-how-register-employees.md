...
ms.author: edupont
---
# <a name="register-employees" />Register Employees
...
## <a name="adding-new-employees" />Adding new employees
...
## <a name="to-set-up-an-employee" />To set up an employee
...
## <a name="to-insert-a-picture-of-an-employee" />To insert a picture of an employee
...
## <a name="to-register-various-information-about-an-employee" />To register various information about an employee
