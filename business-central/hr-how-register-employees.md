...
ms.author: edupont
---
# <a name="register-employees"></a><a name="register-employees"></a>Register Employees
...
## <a name="adding-new-employees"></a><a name="adding-new-employees"></a>Adding new employees
...
## <a name="to-set-up-an-employee"></a><a name="to-set-up-an-employee"></a>To set up an employee
...
## <a name="to-insert-a-picture-of-an-employee"></a><a name="to-insert-a-picture-of-an-employee"></a>To insert a picture of an employee
...
## <a name="to-register-various-information-about-an-employee"></a><a name="to-register-various-information-about-an-employee"></a>To register various information about an employee
