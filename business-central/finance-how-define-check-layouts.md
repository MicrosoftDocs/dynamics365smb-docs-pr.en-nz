...
ms.author: edupont
---
# <a name="select-a-check-layout"></a><a name="select-a-check-layout"></a>Select a Cheque Layout
...
## <a name="to-select-a-check-layout"></a><a name="to-select-a-check-layout"></a>To select a cheque layout
...
## <a name="use-micr-and-security-fonts"></a><a name="use-micr-and-security-fonts"></a>Use MICR and Security Fonts
...
### <a name="micr-e-13b-specifications"></a><a name="micr-e-13b-specifications"></a>MICR E-13B Specifications
...
### <a name="delimiter-characters"></a><a name="delimiter-characters"></a>Delimiter characters
...
### <a name="micr-cmc-7-specifications"></a><a name="micr-cmc-7-specifications"></a>MICR CMC-7 Specifications
...
### <a name="delimiter-characters-1"></a><a name="delimiter-characters-1"></a>Delimiter characters
...
### <a name="secure-font-specifications"></a><a name="secure-font-specifications"></a>Secure Font Specifications
