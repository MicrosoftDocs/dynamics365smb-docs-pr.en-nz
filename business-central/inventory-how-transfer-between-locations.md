...
---
# <a name="transfer-inventory-between-locations" />Transfer Inventory Between Locations
...
## <a name="transfer-orders" />Transfer orders
...
## <a name="item-reclassification-journals" />Item reclassification journals
...
## <a name="to-transfer-items-with-a-transfer-order" />To transfer items with a transfer order
...
### <a name="post-multiple-transfer-orders-in-a-batch" />Post multiple transfer orders in a batch
...
### <a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch" />Schedule a job queue entry to post multiple documents in a batch
...
## <a name="to-transfer-items-with-the-item-reclassification-journal" />To transfer items with the item reclassification journal
...
## <a name="undo-a-transfer-shipment" />Undo a transfer shipment
