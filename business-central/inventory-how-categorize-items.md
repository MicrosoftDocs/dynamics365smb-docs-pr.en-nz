...
ms.author: edupont
---
# <a name="categorize-items"></a><a name="categorize-items"></a><a name="categorize-items"></a>Categorise Items
...
## <a name="to-create-an-item-category"></a><a name="to-create-an-item-category"></a><a name="to-create-an-item-category"></a>To create an item category
...
## <a name="to-assign-an-item-category-to-an-item"></a><a name="to-assign-an-item-category-to-an-item"></a><a name="to-assign-an-item-category-to-an-item"></a>To assign an item category to an item
