...
ms.author: edupont
---
# <a name="categorize-items" />Categorise Items
...
## <a name="to-create-an-item-category" />To create an item category
...
## <a name="to-assign-an-item-category-to-an-item" />To assign an item category to an item
