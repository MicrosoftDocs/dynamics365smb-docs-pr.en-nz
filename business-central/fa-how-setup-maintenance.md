...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance" />Set Up Fixed Asset Maintenance
...
## <a name="to-set-up-general-maintenance-information" />To set up general maintenance information
...
## <a name="to-set-up-maintenance-codes" />To set up maintenance codes
...
## <a name="to-set-up-maintenance-expense-accounts" />To set up maintenance expense accounts
