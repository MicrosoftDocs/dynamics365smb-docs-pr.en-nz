...
### <a name="to-put-away-output-with-an-inventory-put-away"></a>To put away output with an inventory put-away
...
## <a name="to-put-away-assembly-and-production-output-in-advanced-warehouse-configurations"></a>To put away assembly and production output in advanced warehouse configurations
