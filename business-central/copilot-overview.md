...
## <a name="how-does-copilot-use-the-azure-ai-time-quota-that-comes-with-licenses"></a>How does Copilot use the Azure AI time quota that comes with licences?
...
## <a name="does-copilot-need-to-be-trained-on-my-data"></a>Does Copilot need to be trained on my data?
...
## <a name="how-do-i-keep-up-with-the-latest-news-about-copilot-in-business-central"></a>How do I keep up with the latest news about Copilot in Business Central?
