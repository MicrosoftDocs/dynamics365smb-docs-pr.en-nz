...
# <a name="use-word-templates-for-bulk-communication" />Use Word Templates for Bulk Communication
...
## <a name="set-up-the-source-of-data" />Set up the source of data
...
## <a name="add-entries-that-are-related-or-unrelated-to-the-source-entity" />Add entries that are related or unrelated to the source entity
...
### <a name="select-the-fields-to-include" />Select the fields to include
...
## <a name="to-create-a-word-template-in-business-central" />To create a Word template in Business Central
...
## <a name="set-up-the-template-in-word" />Set up the template in Word
...
## <a name="apply-a-template" />Apply a template
...
## <a name="use-word-templates-with-email" />Use Word templates with email
...
## <a name="edit-a-word-template" />Edit a Word template
