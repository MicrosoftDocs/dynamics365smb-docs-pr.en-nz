...
ms.author: bholtorf
---
# <a name="set-up-locations"></a><a name="set-up-locations"></a>Set Up Locations
...
## <a name="location-cards"></a><a name="location-cards"></a>Location cards
...
### <a name="to-set-up-a-location"></a><a name="to-set-up-a-location"></a>To set up a location
...
### <a name="to-create-a-transfer-route"></a><a name="to-create-a-transfer-route"></a>To create a transfer route
...
## <a name="bins"></a><a name="bins"></a>Bins
...
## <a name="default-dimensions-for-locations"></a><a name="default-dimensions-for-locations"></a>Default Dimensions for Locations
...
### <a name="example-of-default-dimensions-on-locations"></a><a name="example-of-default-dimensions-on-locations"></a>Example of default dimensions on locations
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>See related training at [Microsoft Learn](/learn/modules/trade-set-up-dynamics-365-business-central/)
