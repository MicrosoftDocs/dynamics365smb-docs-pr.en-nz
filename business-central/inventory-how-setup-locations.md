...
ms.author: bholtorf
---
# <a name="set-up-locations" />Set Up Locations
...
## <a name="location-cards" />Location cards
...
### <a name="to-set-up-a-location" />To set up a location
...
### <a name="to-create-a-transfer-route" />To create a transfer route
...
## <a name="default-dimensions-for-locations" />Default Dimensions for Locations
...
### <a name="example-of-default-dimensions-on-locations" />Example of default dimensions on locations
...
## <a name="see-related-training-at-microsoft-learnlearnmodulestrade-set-up-dynamics-365-business-central" />See related training at [Microsoft Learn](/learn/modules/trade-set-up-dynamics-365-business-central/)
