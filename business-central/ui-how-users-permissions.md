...
ms.reviewer: jswymer
---
# <a name="create-users-according-to-licenses" />Create Users According to Licences
...
## <a name="manage-users-and-licenses-in-online-tenants" />Manage users and licences in online tenants
...
### <a name="to-remove-a-users-access-to-the-system" />To remove a user's access to the system
...
### <a name="a-namemasynchronization-with-microsoft-" /><a name="m365"></a>Synchronisation with Microsoft 365
...
## <a name="manage-users-and-licenses-in-on-premises-deployments" />Manage users and licences in on-premises deployments
...
### <a name="to-edit-or-delete-a-user-in-an-on-premises-deployment" />To edit or delete a user in an on-premises deployment
