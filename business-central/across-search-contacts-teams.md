...
# <a name="searching-for-customers-vendors-and-other-contacts-from-microsoft-teams" />Searching for Customers, Vendors, and Other Contacts from Microsoft Teams
...
## <a name="look-up-contacts-from-the-command-box" />Look up contacts from the command box
...
## <a name="look-up-contacts-from-the-message-compose-box" />Look up contacts from the message compose box
...
### <a name="heres-another-way" />Here's another way
...
## <a name="viewing-contact-card-details" />Viewing contact card details
