...
---
# <a name="set-up-intercompany-transactions" />Set Up Intercompany Transactions
...
## <a name="overview-of-the-steps-to-get-started" />Overview of the steps to get started
...
## <a name="set-up-a-synchronization-partner" />Set up a synchronisation partner
...
## <a name="set-up-the-intercompany-charts-of-accounts" />Set up the intercompany charts of accounts
...
### <a name="import-or-export-an-intercompany-chart-of-accounts" />Import or export an intercompany chart of accounts
...
## <a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts" />Map the intercompany chart of accounts to your company's chart of accounts
...
## <a name="set-up-intercompany-dimensions" />Set up intercompany dimensions
...
### <a name="import-or-export-intercompany-dimensions" />Import or export intercompany dimensions
...
### <a name="map-intercompany-dimensions-to-your-companys-dimensions" />Map intercompany dimensions to your company's dimensions
...
## <a name="set-up-intercompany-general-journal-templates-and-batches" />Set up intercompany general journal templates and batches
...
## <a name="set-up-a-company-for-intercompany-transactions" />Set up a company for intercompany transactions
...
## <a name="set-up-intercompany-partners" />Set up intercompany partners
...
### <a name="set-up-intercompany-partners-as-customers-and-vendors" />Set up intercompany partners as customers and vendors
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts" />Set up default intercompany partner general ledger accounts
...
### <a name="auto-accept-transactions-from-intercompany-partners" />Auto-accept transactions from intercompany partners
...
### <a name="specify-the-bank-accounts-to-use-for-intercompany-partners" />Specify the bank accounts to use for intercompany partners
...
## <a name="troubleshoot-your-intercompany-setup" />Troubleshoot your intercompany setup
