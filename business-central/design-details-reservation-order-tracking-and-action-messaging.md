...
|8A-8B Net Amt. of Your Obligations (9)|-|COMPONENT|EAST|-30|Tracking|Component|-|5407|1001004|-| 
|8A-8B Net Amt. of Your Obligations (9)|Yes|COMPONENT|EAST|30|Tracking|Component|LOTA|32|-|-| 
...
#### <a name="entry-number-10"></a>Entry number 10
...
|Entry No.|Positive|Item No.|Location Code|Quantity|Reservation Status|Description|Lot No.|Source Type|Source ID|Binding|  
|---------|--------|--------|-------------|--------|------------------|-----------|-------|-----------|---------|-------| 
|8A-8B Net Amt. of Your Obligations (9)|-|COMPONENT|EAST|-30|Surplus|Component|-|5407|1001004|-| 
|10|-|PRODUCED ITEM|WEST|-100|Reservation|Produced Item|-|37|1001|Order-to-Order|
|10|Yes|PRODUCED ITEM|WEST|100|Reservation|Produced Item|-|5406|101004|Order-to-Order|
...
#### <a name="entry-numbers-8-and-9-1"></a>Entry numbers 8 and 9
...
The order tracking system always attempts to resolve an imbalance in the existing order network. If this isn't possible, it issues an action message to create a new order. Following is the prioritised list that the order tracking system uses when it determines how to restore balance. If an additional demand has entered the order network, the system seeks to order track through the following checks:  
