...
# <a name="set-up-contact-sync-with-outlook-for-business-central-on-premises"></a><a name="set-up-contact-sync-with-outlook-for-business-central-on-premises"></a>Set up contact sync with Outlook for Business Central on-premises
...
## <a name="set-up-contact-sync"></a><a name="set-up-contact-sync"></a>Set up contact sync
