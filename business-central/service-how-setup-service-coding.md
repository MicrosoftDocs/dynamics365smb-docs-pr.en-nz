...
# <a name="set-up-standard-service-codes" />Set Up Standard Service Codes
...
## <a name="to-set-up-a-standard-service-code" />To set up a standard service code
...
## <a name="to-assign-a-standard-service-code-to-a-service-item-group" />To assign a standard service code to a service item group
