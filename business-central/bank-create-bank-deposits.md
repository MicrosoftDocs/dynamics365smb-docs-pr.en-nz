...
ms.author: bholtorf
---
# <a name="create-bank-deposits" />Create Bank Deposits
> [!NOTE]
...
### <a name="number-series-and-lump-sum-deposits" />Number Series and Lump Sum Deposits
...
### <a name="general-journal-templates-for-bank-deposits" />General Journal Templates for Bank Deposits
...
## <a name="dimensions-on-bank-deposit-lines" />Dimensions on Bank Deposit Lines
...
## <a name="create-a-bank-deposit" />Create a Bank Deposit
...
## <a name="finding-posted-bank-deposits" />Finding Posted Bank Deposits
...
## <a name="reversing-a-posted-bank-deposit" />Reversing a Posted Bank Deposit
