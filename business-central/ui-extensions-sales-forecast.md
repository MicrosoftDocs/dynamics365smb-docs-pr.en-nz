...
# <a name="the-sales-and-inventory-forecast-extension" />The Sales and Inventory Forecast Extension
...
## <a name="setting-up-forecasting" />Setting up forecasting
...
## <a name="use-the-forecasts" />Use the forecasts
...
## <a name="a-nameanchortext-acreate-and-use-your-own-predictive-web-service-for-sales-and-inventory-forecasts" /><a name="AnchorText"> </a>Create and use your own predictive web service for sales and inventory forecasts
...
## <a name="see-related-microsoft-trainingtrainingmodulesuse-sales-inventory-forecast-extension" />See related [Microsoft training](/training/modules/use-sales-inventory-forecast-extension/)
