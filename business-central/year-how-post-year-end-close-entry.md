...
ms.author: edupont
---
# <a name="posting-the-year-end-closing-entry" />Posting the Year-End Closing Entry
...
## <a name="to-post-the-year-end-closing-entry" />To post the year end closing entry
