...
ms.author: edupont
---
# <a name="set-up-or-change-the-chart-of-accounts" />Set Up or Change the Chart of Accounts
...
## <a name="add-or-change-accounts" />Add or change accounts
...
## <a name="delete-accounts" />Delete accounts
...
## <a name="block-deletion-of-gl-accounts" />Block deletion of G/L accounts
...
## <a name="see-related-microsoft-training" />See related [Microsoft training](/training/modules/chart-accounts-dynamics-365-business-central/index)
