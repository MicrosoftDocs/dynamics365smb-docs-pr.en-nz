...
### <a name="sign-up-power-bi" />Sign up Power BI
...
## <a name="work-with-power-bi-reports" />Work with Power BI reports

### <a name="show-reports-on-list-pages" />Show reports on list pages
...
### <a name="switch-reports" />Switch reports
...
### <a name="get-more-reports" />Get more reports
...
### <a name="manage-and-modify-reports" />Manage and modify reports
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page" />You can't see a report on the Select Report page on a list page
