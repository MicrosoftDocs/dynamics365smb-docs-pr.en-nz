...
ms.author: jswymer
---
# <a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a>Work with Power BI Reports in [!INCLUDE [prod_short](includes/prod_short.md)]
...
### <a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a>Sign up Power BI
...
## <a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect"></a>Connect to Power BI - one time only
...
#### <a name="from--on-premises"></a><a name="from--on-premises"></a>From [!INCLUDE [prod_short](includes/prod_short.md)] on-premises
...
## <a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a>Work with Power BI reports

### <a name="show-reports-on-list-pages"></a><a name="show-reports-on-list-pages"></a>Show reports on list pages
...
### <a name="switch-reports"></a><a name="switch-reports"></a>Switch reports
...
### <a name="get-more-reports"></a><a name="get-more-reports"></a>Get more reports
...
### <a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a>Manage and modify reports
...
### <a name="upload-reports"></a><a name="upload-reports"></a><a name="upload"></a>Upload reports
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a>You can't see a report on the Select Report page on a list page
