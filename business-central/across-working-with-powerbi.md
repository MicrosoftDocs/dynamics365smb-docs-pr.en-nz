...
ms.author: jswymer
---
# <a name="work-with-power-bi-reports-in-"></a>Work with Power BI Reports in [!INCLUDE [prod_short](includes/prod_short.md)]
...
#### <a name="from--on-premises"></a>From [!INCLUDE [prod_short](includes/prod_short.md)] on-premises

Connecting to Power BI from [!INCLUDE [prod_short](includes/prod_short.md)] is similar to online. However, you might be prompted on the **MICROSOFT ENTRA SERVICE PERMISSIONS** page to grant access to Power BI Services. To grant access, select **Authorise Azure Services**, and then **Accept**.
