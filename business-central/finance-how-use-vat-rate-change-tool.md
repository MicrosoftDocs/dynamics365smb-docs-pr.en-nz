...
# <a name="managing-vat-rate-changes" />Managing GST Rate Changes
...
## <a name="changing-vat-rates" />Changing GST rates
...
## <a name="the-vat-rate-change-tool" />The GST Rate Change tool
...
## <a name="understanding-the-vat-rate-conversion-process-and-limitations" />Understanding the GST rate conversion process and limitations
...
### <a name="to-prepare-vat-rate-change-conversions" />To prepare GST rate change conversions
...
### <a name="to-set-up-the-vat-rate-change-tool" />To set up the GST rate change tool
...
### <a name="to-perform-vat-rate-change-conversion" />To perform GST rate change conversion
