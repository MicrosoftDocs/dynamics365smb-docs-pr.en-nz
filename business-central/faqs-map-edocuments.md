...
# <a name="faq-for-mapping-e-documents-with-purchase-orders-using-copilot-preview"></a>FAQ for mapping e-documents with purchase orders using Copilot (preview)
...
## <a name="what-is-e-documents-matching-assistance"></a>What is E-documents Matching Assistance?
...
## <a name="what-are-capabilities-of-the-e-documents-matching-assistance"></a>What are capabilities of the E-documents Matching Assistance?
...
## <a name="what-is-the-intended-use-of-the-e-documents-matching-assistance"></a>What is the intended use of the E-documents Matching Assistance?
...
## <a name="how-was-e-documents-matching-assistance-evaluated-what-metrics-are-used-to-measure-performance"></a>How was E-documents Matching Assistance evaluated? What metrics are used to measure performance?
...
## <a name="what-are-the-limitations-of-e-documents-matching-assistance-how-can-users-minimize-the-impact-of-the-e-documents-matching-assistance-limitations-when-using-the-system"></a>What are the limitations of E-documents Matching Assistance? How can users minimise the impact of the E-documents Matching Assistance limitations when using the system?
...
## <a name="in-which-geographies-and-languages-is-e-documents-matching-assistance-available"></a>In which geographies and languages is E-documents Matching Assistance available?
...
### <a name="what-is-expected-of-end-users-while-using-e-documents-matching-assistance"></a>What is expected of end-users while using E-Documents Matching Assistance?
...
### <a name="what-is-expected-of-administrators-and-end-users-when-operating-e-documents-matching-assistance"></a>What is expected of administrators and end-users when operating E-Documents Matching Assistance?
...
## <a name="is-copilot-the-only-way-to-match-e-documents-to-purchase-orders"></a>Is Copilot the only way to match e-documents to purchase orders?
