...
ms.author: edupont
---
# <a name="create-workflows-from-workflow-templates" />Create Workflows from Workflow Templates
...
## <a name="to-create-a-workflow-from-a-workflow-template" />To create a workflow from a workflow template
