...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-excel" />Get the Business Central Add-in for Excel
...
### <a name="about-the-add-in" />About the add-in
...
### <a name="about-deployment-as-an-admin" />About deployment as an admin
...
## <a name="preparation-on-premises-only" />Preparation (on-premises only)
...
## <a name="deploy-the-add-in-by-using-centralized-deployment" />Deploy the add-in by using Centralised Deployment
...
### <a name="before-you-begin" />Before you begin
...
### <a name="set-up-centralized-deployment-of-the-add-in" />Set up Centralised Deployment of the add-in
...
### <a name="configure-the-business-central-connection" />Configure the Business Central connection
...
## <a name="prepare-devices-and-network-for-the-excel-add-in" />Prepare devices and network for the Excel Add-In
