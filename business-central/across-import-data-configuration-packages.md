...
ms.author: edupont
---
# <a name="import-business-data-from-other-finance-systems"></a><a name="import-business-data-from-other-finance-systems"></a>Import Business Data from Other Finance Systems
...
## <a name="work-with-data-in-excel"></a><a name="work-with-data-in-excel"></a>Work with Data in Excel
...
## <a name="import-data-from-configuration-packages"></a><a name="import-data-from-configuration-packages"></a>Import Data from Configuration Packages
...
### <a name="tables-in-the-default-configuration-package"></a><a name="tables-in-the-default-configuration-package"></a>Tables in the Default Configuration Package
