...
ms.author: edupont
---
# <a name="import-business-data-from-other-finance-systems" />Import Business Data from Other Finance Systems
...
## <a name="work-with-data-in-excel" />Work with Data in Excel
...
## <a name="import-data-from-configuration-packages" />Import Data from Configuration Packages
...
### <a name="tables-in-the-default-configuration-package" />Tables in the Default Configuration Package
