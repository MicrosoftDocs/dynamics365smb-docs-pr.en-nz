...
ms.author: edupont
---
# <a name="copy-existing-items-to-create-new-items" />Copy Existing Items to Create New Items
...
## <a name="to-copy-an-existing-item-to-a-new-item" />To copy an existing item to a new item
