...
ms.author: edupont
---
# <a name="reconcile-payments-that-cannot-be-applied-automatically" />Reconcile Payments that Cannot be Applied Automatically
...
## <a name="to-reconcile-payments-that-cannot-be-applied-automatically" />To reconcile payments that cannot be applied automatically
