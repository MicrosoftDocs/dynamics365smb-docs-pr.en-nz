...
---
# <a name="reconcile-payments-that-cant-be-applied-automatically"></a>Reconcile payments that can't be applied automatically
...
## <a name="to-reconcile-payments-that-cant-be-applied-automatically"></a>To reconcile payments that can't be applied automatically
