...
ms.author: jswymer
---
# <a name="managing-onedrive-integration-with-business-central" />Managing OneDrive Integration with Business Central
...
## <a name="configure-onedrive-for-integration-with-business-central" />Configure OneDrive for integration with Business Central
...
### <a name="managing-privacy" />Managing privacy
...
## <a name="configure-business-central" />Configure Business Central
...
### <a name="about-multiple-environments" />About multiple environments
...
### <a name="configure-onedrive-using-onedrive-setup" />Configure OneDrive using OneDrive Setup
...
### <a name="switching-to-new-onedrive-integration-after-upgrade" />Switching to new OneDrive integration after upgrade
