...
# <a name="set-up-cost-accounting"></a>Set up cost accounting

Before you start working with cost accounting, you must perform setup tasks.

## <a name="balances-between-cost-type-cost-center-and-cost-object"></a>Balances between Cost Type, Cost Center, and Cost Object
