...
ms.author: jswymer
---
# <a name="welcome-to-includeprodlongincludesprodlongmd" />Welcome to [!INCLUDE[prod_long](includes/prod_long.md)]
...
## <a name="business-processes" />Business Processes
...
## <a name="development-and-administration-content" />Development and administration content
...
## <a name="community-resources" />Community Resources
...
## <a name="get-notified-about-changes-through-an-rss-feed" />Get notified about changes through an RSS feed

[!INCLUDE [ua-rss](includes/ua-rss.md)]  

## <a name="see-related-microsoft-learn-trainingtrainingdynamics365business-centralwtmciddyn365bclandingpage-docs" />See related [Microsoft Learn training](/training/dynamics365/business-central?WT.mc_id=dyn365bc_landingpage-docs)
