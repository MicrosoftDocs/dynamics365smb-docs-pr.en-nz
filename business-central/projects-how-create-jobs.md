...
ms.author: edupont
---
# <a name="create-jobs"></a><a name="create-jobs"></a><a name="create-jobs"></a>Create Jobs
...
## <a name="to-create-a-job-card"></a><a name="to-create-a-job-card"></a><a name="to-create-a-job-card"></a>To create a job card
...
## <a name="to-create-tasks-for-a-job"></a><a name="to-create-tasks-for-a-job"></a><a name="to-create-tasks-for-a-job"></a>To create tasks for a job
...
## <a name="to-create-planning-lines-for-a-job"></a><a name="to-create-planning-lines-for-a-job"></a><a name="to-create-planning-lines-for-a-job"></a>To create planning lines for a job
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>See related [Microsoft training](/training/modules/create-new-job/)
