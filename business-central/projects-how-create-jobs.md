...
## <a name="to-create-a-project-card"></a>Invoice one or more customers for project tasks
...
## <a name="to-create-tasks-for-a-project"></a>Invoice one customer for multiple project tasks
...
## <a name="invoice-one-or-more-customers-for-project-tasks"></a>To create a project card
...
## <a name="specify-a-default-location-for-project-items"></a>To create tasks for a project
