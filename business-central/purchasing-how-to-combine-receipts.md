...
ms.author: edupont
---
# <a name="combine-receipts-on-a-single-invoice" />Combine Receipts on a Single Invoice
...
## <a name="to-combine-receipts" />To combine receipts
...
## <a name="to-remove-open-purchase-orders-after-combined-receipt-posting" />To remove open purchase orders after combined receipt posting
