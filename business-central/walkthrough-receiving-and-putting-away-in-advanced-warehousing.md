...
ms.author: edupont
---
# <a name="walkthrough-receiving-and-putting-away-in-advanced-warehouse-configurations" />Walkthrough: Receiving and Putting Away in Advanced Warehouse Configurations
...
## <a name="reviewing-the-white-location-setup" />Reviewing the WHITE Location Setup

The setup of the **Location Card** page defines the company's warehouse flows.  

### <a name="to-review-the-location-setup" />To review the location setup
...
## <a name="creating-the-purchase-orders" />Creating the Purchase Orders

Purchase orders are the most common type of inbound source document.  

### <a name="to-create-the-purchase-orders" />To create the purchase orders
...
## <a name="putting-the-items-away" />Putting the Items Away
...
### <a name="to-put-the-items-away" />To put the items away
