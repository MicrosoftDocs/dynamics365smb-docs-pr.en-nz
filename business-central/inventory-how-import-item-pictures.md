...
ms.author: edupont
---
# <a name="import-multiple-item-pictures" />Import Multiple Item Pictures
...
## <a name="to-name-picture-files-by-the-item-names-and-prepare-the-zip-file" />To name picture files by the item names and prepare the ZIP file
...
## <a name="to-import-item-pictures" />To import item pictures
