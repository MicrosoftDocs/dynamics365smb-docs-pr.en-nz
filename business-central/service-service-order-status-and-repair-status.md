...
ms.author: edupont
---
# <a name="service-order-status-and-repair-status"></a><a name="service-order-status-and-repair-status"></a><a name="service-order-status-and-repair-status"></a>Service Order Status and Repair Status
...
## <a name="specifying-service-order-status-for-repair-status"></a><a name="specifying-service-order-status-for-repair-status"></a><a name="specifying-service-order-status-for-repair-status"></a>Specifying Service Order Status for Repair Status
...
### <a name="pending"></a><a name="pending"></a><a name="pending"></a>Pending
...
### <a name="in-process"></a><a name="in-process"></a><a name="in-process"></a>In Progress
...
### <a name="on-hold"></a><a name="on-hold"></a><a name="on-hold"></a>On Hold
...
### <a name="finished"></a><a name="finished"></a><a name="finished"></a>Finished
...
## <a name="assigning-priority-to-service-order-status"></a><a name="assigning-priority-to-service-order-status"></a><a name="assigning-priority-to-service-order-status"></a>Assigning Priority to Service Order Status
