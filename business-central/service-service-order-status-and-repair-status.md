...
ms.author: edupont
---
# <a name="service-order-status-and-repair-status" />Service Order Status and Repair Status
...
## <a name="specifying-service-order-status-for-repair-status" />Specifying Service Order Status for Repair Status
...
## <a name="assigning-priority-to-service-order-status" />Assigning Priority to Service Order Status
