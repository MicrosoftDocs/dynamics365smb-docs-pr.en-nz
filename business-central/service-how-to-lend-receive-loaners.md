...
ms.author: bholtorf
---
# <a name="lend-and-receive-loaners" />Lend and Receive Loaners
You can lend customers loaners to temporarily replace service items that you have received for servicing.  
  
## <a name="to-lend-a-loaner-item" />To lend a loaner item
...
## <a name="to-receive-a-loaner" />To receive a loaner
...
## <a name="to-register-loaner-comments" />To register loaner comments
