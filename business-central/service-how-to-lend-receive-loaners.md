...
ms.author: bholtorf
---
# <a name="lend-and-receive-loaners"></a><a name="lend-and-receive-loaners"></a><a name="lend-and-receive-loaners"></a>Lend and Receive Loaners
You can lend customers loaners to temporarily replace service items that you have received for servicing.  
  
## <a name="to-lend-a-loaner-item"></a><a name="to-lend-a-loaner-item"></a><a name="to-lend-a-loaner-item"></a>To lend a loaner item
...
## <a name="to-receive-a-loaner"></a><a name="to-receive-a-loaner"></a><a name="to-receive-a-loaner"></a>To receive a loaner
...
## <a name="to-register-loaner-comments"></a><a name="to-register-loaner-comments"></a><a name="to-register-loaner-comments"></a>To register loaner comments
