...
---
# <a name="manage-project-budgets"></a>Manage Job Budgets
...
## <a name="to-estimate-the-budgeted-costs-for-a-project"></a><a name="JobBudgetCosts"></a>To estimate the budgeted costs for a job
