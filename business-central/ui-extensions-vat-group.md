...
# <a name="the-vat-group-management-extension-for-the-united-kingdom" />The GST Group Management Extension for the United Kingdom
...
## <a name="forming-a-vat-group" />Forming a GST group
...
## <a name="set-up-a-vat-group" />Set up a GST group
...
## <a name="set-up-vat-group-members" />Set up GST group members
...
### <a name="vat-group-representative-uses-business-central-online" />GST group representative uses Business Central online
...
### <a name="vat-group-representative-uses-business-central-on-premises" />GST group representative uses Business Central on-premises
...
## <a name="set-up-the-vat-group-representative" />Set up the GST group representative
...
## <a name="use-the-vat-group-management-features" />Use the GST group management features
...
### <a name="review-vat-member-submissions" />Review GST member submissions
...
### <a name="create-a-group-vat-return" />Create a group GST return
