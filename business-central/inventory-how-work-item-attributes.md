...
ms.author: edupont
---
# <a name="work-with-item-attributes" />Work with item attributes
...
## <a name="create-item-attributes" />Create item attributes
...
## <a name="create-values-for-item-attributes-of-type-option" />Create values for item attributes of type Option
...
## <a name="assign-item-attributes-to-items" />Assign item attributes to items
...
## <a name="assign-item-attributes-to-item-categories" />Assign item attributes to item categories
...
## <a name="filter-by-item-attributes" />Filter by item attributes
