...
ms.author: edupont
---
# <a name="convert-service-contracts-that-include-vat-amounts" />Convert Service Contracts that Include GST Amounts
...
### <a name="to-create-a-credit-memo-for-vat-difference" />To create a credit memo for GST difference
