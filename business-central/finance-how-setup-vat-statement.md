...
ms.author: bholtorf
---
# <a name="set-up-vat-statement-templates-and-vat-statement-names" />Set Up GST Statement Templates and GST Statement Names
...
## <a name="to-define-a-vat-statement" />To define a GST statement
...
## <a name="to-preview-the-vat-statement" />To preview the GST statement
