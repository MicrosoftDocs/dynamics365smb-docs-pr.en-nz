...
# <a name="keyboard-quick-reference---pc-only"></a><a name="keyboard-quick-reference---pc-only"></a>Keyboard quick reference - PC only
...
#### <a name="navigate--select-rows"></a><a name="navigate--select-rows"></a>Navigate & select rows
...
#### <a name="copy--paste"></a><a name="copy--paste"></a>Copy & paste
...
#### <a name="search-filter--sort"></a><a name="search-filter--sort"></a>Search, filter, & sort
...
#### <a name="quick-entry"></a><a name="quick-entry"></a>Quick entry
...
##### <a name="report-preview"></a><a name="report-preview"></a>Report preview

|Select these keys|To do this|
|-|-|
|<kbd>Ctrl</kbd>+<kbd>Home</kbd>/<kbd>End</kbd>|Go to the first/last page|

#### <a name="numeric-keypad"></a><a name="numeric-keypad"></a>Numeric keypad
