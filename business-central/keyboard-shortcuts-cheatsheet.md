...
# <a name="keyboard-quick-reference---pc-only" />Keyboard quick reference - PC only
...
#### <a name="navigate--select-rows" />Navigate & select rows
...
#### <a name="search-filter--sort" />Search, filter, & sort
...
#### <a name="quick-entry" />Quick entry
...
##### <a name="report-preview" />Report preview

|Select these keys|To do this|
|-|-|
|<kbd>Ctrl</kbd>+<kbd>Home</kbd>/<kbd>End</kbd>|Go to the first/last page|

#### <a name="numeric-keypad" />Numeric keypad
