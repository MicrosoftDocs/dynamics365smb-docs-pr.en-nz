...
---
# <a name="assemble-items"></a><a name="assemble-items"></a>Assemble Items
...
## <a name="to-assemble-an-item-to-stock"></a><a name="to-assemble-an-item-to-stock"></a>To assemble an item to stock
