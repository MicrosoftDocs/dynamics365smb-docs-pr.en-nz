...
ms.author: bholtorf
---
# <a name="create-production-boms" />Create Production BOMs
...
## <a name="to-create-a-production-bom" />To create a production BOM
...
## <a name="to-create-a-new-version-of-a-production-bom" />To create a new version of a production BOM
...
## <a name="quantity-calculation-formula-on-production-boms" />Quantity calculation formula on production BOMs
