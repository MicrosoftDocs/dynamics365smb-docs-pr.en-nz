...
ms.author: bholtorf
---
# <a name="block-items-from-sales-or-purchasing" />Block Items from Sales or Purchasing
...
## <a name="to-block-an-item-from-being-entered-on-sales-lines" />To block an item from being entered on sales lines

1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Items**, and then choose the related link.  
2. Select the item that you want to block, and then select the **Sales Blocked** checkbox.  

## <a name="to-block-an-item-from-being-entered-on-purchase-lines" />To block an item from being entered on purchase lines

1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Items**, and then choose the related link.  
2. Select the item that you want to block, and then select the **Purchasing Blocked** checkbox.  

## <a name="to-block-an-item-from-being-posted" />To block an item from being posted
