...
# <a name="business-central-for-multi-site-and-international-organizations" />Business Central for Multi-Site and International Organisations
...
## <a name="integrating-the-headquarter-company-and-the-sites" />Integrating the Headquarter Company and the Sites
...
## <a name="meet-the-needs-of-domestic-and-international-sites" />Meet the Needs of Domestic and International Sites
...
## <a name="consolidate-financial-data" />Consolidate Financial Data
...
## <a name="share-business-insight-with-integrated-analytics" />Share Business Insight with Integrated Analytics
...
## <a name="exchange-data-using-apis-and-xmlports" />Exchange Data Using APIs and XMLports
...
## <a name="promote-an-efficient-intercompany-supply-chain" />Promote an Efficient Intercompany Supply Chain
...
## <a name="respond-quickly-to-new-business-conditions" />Respond Quickly to New Business Conditions
