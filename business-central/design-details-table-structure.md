...
## <a name="transaction-and-budget-tables" />Transaction and Budget Tables
...
### <a name="tables-that-contain-the-dimension-set-id-field" />Tables That Contain the Dimension Set ID Field
