...
---
# <a name="mapping-the-tables-and-fields-to-synchronize"></a>Mapping the tables and fields to synchronize
...
### <a name="add-table-and-field-mappings-to-existing-integration-tables"></a>Add table and field mappings to existing integration tables
