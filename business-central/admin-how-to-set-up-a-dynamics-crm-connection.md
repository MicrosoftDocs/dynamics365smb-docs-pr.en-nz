...
ms.author: bholtorf
---
# <a name="connect-to-microsoft-dataverse"></a><a name="connect-to-microsoft-dataverse"></a><a name="connect-to-microsoft-dataverse"></a>Connect to Microsoft Dataverse
...
## <a name="set-up-a-connection-to-"></a><a name="set-up-a-connection-to-"></a><a name="set-up-a-connection-to-"></a>Set up a connection to [!INCLUDE[cds_long_md](includes/cds_long_md.md)]
...
### <a name="to-use-the-dataverse-connection-setup-assisted-setup-guide"></a><a name="to-use-the-dataverse-connection-setup-assisted-setup-guide"></a><a name="to-use-the-dataverse-connection-setup-assisted-setup-guide"></a>To use the Dataverse Connection Setup assisted setup guide
...
### <a name="to-create-or-maintain-the-connection-manually"></a><a name="to-create-or-maintain-the-connection-manually"></a><a name="to-create-or-maintain-the-connection-manually"></a>To create or maintain the connection manually
...
## <a name="customize-the-match-based-coupling"></a><a name="customize-the-match-based-coupling"></a><a name="customize-the-match-based-coupling"></a>Customise the match-based coupling
...
### <a name="view-the-results-of-the-coupling-job"></a><a name="view-the-results-of-the-coupling-job"></a><a name="view-the-results-of-the-coupling-job"></a>View the results of the coupling job
...
## <a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication"></a><a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication"></a><a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication"></a>Upgrade connections from Business Central online to use certificate-based authentication
...
### <a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication"></a><a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication"></a><a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication"></a>To upgrade your Business Central online connection to use certificate-based authentication
...
## <a name="connecting-on-premises-versions"></a><a name="connecting-on-premises-versions"></a><a name="connecting-on-premises-versions"></a>Connecting on-premises versions
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse"></a><a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse"></a><a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse"></a>To register an application in Azure AD for connecting from Business Central to Dataverse
...
### <a name="to-disconnect-from-"></a><a name="to-disconnect-from-"></a><a name="to-disconnect-from-"></a>To disconnect from [!INCLUDE[cds_long_md](includes/cds_long_md.md)]
