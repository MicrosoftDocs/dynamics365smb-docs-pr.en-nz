...
### <a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication" />To upgrade your Business Central online connection to use certificate-based authentication
