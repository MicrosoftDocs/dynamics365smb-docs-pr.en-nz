...
ms.author: edupont
---
# <a name="troubleshooting-your-company-hub"></a><a name="troubleshooting-your-company-hub"></a>Troubleshooting Your Company Hub
...
## <a name="check-errors"></a><a name="check-errors"></a>Check errors
...
## <a name="connection-failed"></a><a name="connection-failed"></a>Connection failed
...
## <a name="data-does-not-refresh"></a><a name="data-does-not-refresh"></a>Data does not refresh
