...
# <a name="walkthrough-set-up-and-use-the-shopify-connector" />Walkthrough: Set up and use the Shopify Connector
...
## <a name="connect-business-central-to-the-shopify-shop" />Connect Business Central to the Shopify shop
...
## <a name="walkthrough-start-selling-products-online" />Walkthrough: Start selling products online
...
#### <a name="prepare-data" />Prepare data
...
#### <a name="run-the-synchronization" />Run the synchronisation
