...
In **Shopify Admin**, notice that both the Company and the customer were imported. Open the customers and notice the Company fact box with link to Company, location and assigned permissions. Select **[...]** in the **Company fact box, then select **Send B2B access email** to invite the customer.
