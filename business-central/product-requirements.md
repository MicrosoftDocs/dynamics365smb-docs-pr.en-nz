...
---
# <a name="minimum-requirements-for-using-business-central"></a><a name="minimum-requirements-for-using-business-central"></a>Minimum Requirements for Using Business Central
...
## <a name="mobile-devices"></a><a name="mobile-devices"></a>Mobile devices
...
## <a name="using-the-business-central-administration-center"></a><a name="using-the-business-central-administration-center"></a><a name="TAC"></a> Using the Business Central Administration Centre
