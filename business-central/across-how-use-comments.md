...
ms.author: edupont
---
# <a name="add-comments-to-cards-and-documents" />Add Comments to Cards and Documents
...
## <a name="to-add-a-comments-to-an-item-card" />To add a comments to an item card
