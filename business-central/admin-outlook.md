...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-outlook" />Get the Business Central Add-in for Outlook
...
## <a name="about-the-business-central-add-in-for-outlook" />About the Business Central add-in for Outlook
...
## <a name="deploy-the-add-in-by-using-centralized-deployment-as-an-admin" />Deploy the add-in by using Centralised Deployment as an admin
...
### <a name="deploy-the-add-in" />Deploy the add-in
