...
ms.author: edupont
---
# <a name="calculate-order-promising-dates"></a><a name="calculate-order-promising-dates"></a>Calculate Order Promising Dates
...
## <a name="about-order-promising"></a><a name="about-order-promising"></a>About Order Promising
...
### <a name="calculations"></a><a name="calculations"></a>Calculations
...
## <a name="to-set-up-order-promising"></a><a name="to-set-up-order-promising"></a>To set up order promising
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising"></a><a name="inbound-and-outbound-warehouse-handling-times-in-order-promising"></a>Inbound and Outbound Warehouse Handling Times in Order Promising
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations"></a><a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations"></a>To enter inbound and outbound warehouse handling times on locations
...
## <a name="to-make-an-item-critical"></a><a name="to-make-an-item-critical"></a>To make an item critical
...
## <a name="to-calculate-an-order-promising-date"></a><a name="to-calculate-an-order-promising-date"></a>To calculate an order promising date
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>See related [Microsoft training](/training/modules/promising-sales-order-delivery-dynamics-365-business-central/)
