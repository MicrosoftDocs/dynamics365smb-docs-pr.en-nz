...
ms.author: edupont
---
# <a name="calculate-order-promising-dates" />Calculate Order Promising Dates
...
## <a name="about-order-promising" />About Order Promising
...
### <a name="calculations" />Calculations
...
## <a name="to-set-up-order-promising" />To set up order promising
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising" />Inbound and Outbound Warehouse Handling Times in Order Promising
...
#### <a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents" />To enter default inbound and outbound warehouse handling times for sales and purchase documents
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations" />To enter inbound and outbound warehouse handling times on locations
...
## <a name="to-make-an-item-critical" />To make an item critical
...
## <a name="to-calculate-an-order-promising-date" />To calculate an order promising date
...
## <a name="see-related-microsoft-training" />See related [Microsoft training](/training/modules/promising-sales-order-delivery-dynamics-365-business-central/)
