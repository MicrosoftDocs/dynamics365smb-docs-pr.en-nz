...
ms.author: jswymer
---
# <a name="process-sales-opportunities" />Process Sales Opportunities
...
## <a name="to-view-opportunities" />To view opportunities
...
## <a name="to-close-opportunities" />To close opportunities
...
## <a name="to-create-quotes-for-opportunities" />To create quotes for opportunities
> [!NOTE]
...
## <a name="to-create-sales-orders-for-opportunities" />To create sales orders for opportunities
...
## <a name="to-delete-opportunities" />To delete opportunities
...
## <a name="to-move-an-opportunity-through-sales-cycle-stages" />To move an opportunity through sales cycle stages
