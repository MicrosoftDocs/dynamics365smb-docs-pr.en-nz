...
# <a name="handling-lot-sizes-in-production"></a><a name="handling-lot-sizes-in-production"></a>Handling Lot Sizes in Production
...
## <a name="units-of-measure-in-production-bill-of-materials"></a><a name="units-of-measure-in-production-bill-of-materials"></a>Units of Measure in Production Bill of Materials
...
## <a name="lot-size-on-routing-lines"></a><a name="lot-size-on-routing-lines"></a>Lot size on routing lines
...
## <a name="lot-sizes-for-items-and-stockkeeping-units"></a><a name="lot-sizes-for-items-and-stockkeeping-units"></a>Lot Sizes for Items and Stockkeeping Units
...
## <a name="lot-size-on-item-and-stockkeeping-units"></a><a name="lot-size-on-item-and-stockkeeping-units"></a>Lot size on item and stockkeeping units
