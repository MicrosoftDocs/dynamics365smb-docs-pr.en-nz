...
ms.author: jswymer
---
# <a name="enabling-power-bi-integration-with-" />Enabling Power BI Integration With [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="power-bi-licensing" /><a name="license"></a>Power BI Licensing
...
## <a name="expose-data-through-api-or-odata-web-services" /><a name="exposedata"></a>Expose data through API or OData web services
...
## <a name="set-up--on-premises-for-power-bi-integration" /><a name="setup"></a>Set up [!INCLUDE[prod_short](includes/prod_short.md)] on-premises for Power BI integration
