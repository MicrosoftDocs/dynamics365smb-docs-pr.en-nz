...
ms.author: jswymer
---
# <a name="enabling-power-bi-integration-with-includeprodshortincludesprodshortmd" />Enabling Power BI Integration With [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="a-namelicenseapower-bi-licensing" /><a name="license"></a>Power BI Licensing
...
## <a name="a-nameexposedataaexpose-data-through-api-or-odata-web-services" /><a name="exposedata"></a>Expose data through API or OData web services
...
### <a name="api-pages-and-queries" />API pages and queries
...
### <a name="odata-web-services" />OData web services
...
### <a name="choosing-whether-to-use-api-pages-or-odata-web-services" />Choosing whether to use API pages or OData web services
...
## <a name="a-namesetupaset-up-includeprodshortincludesprodshortmd-on-premises-for-power-bi-integration" /><a name="setup"></a>Set up [!INCLUDE[prod_short](includes/prod_short.md)] on-premises for Power BI integration
