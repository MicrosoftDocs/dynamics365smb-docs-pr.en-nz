...
---
# <a name="analyze-data-with-statistical-accounts" />Analyse Data with Statistical Accounts
...
## <a name="set-up-a-statistical-account" />Set up a statistical account
...
## <a name="post-amounts-to-a-statistical-account" />Post amounts to a statistical account
...
## <a name="verify-statistical-account-amounts" />Verify statistical account amounts
...
## <a name="include-the-statistical-account-in-a-financial-report" />Include the statistical account in a financial report
