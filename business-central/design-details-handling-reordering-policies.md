...
---
# <a name="design-details-handling-reordering-policies"></a><a name="design-details-handling-reordering-policies"></a><a name="design-details-handling-reordering-policies"></a>Design Details: Handling Reordering Policies
...
## <a name="the-role-of-the-reorder-point"></a><a name="the-role-of-the-reorder-point"></a><a name="the-role-of-the-reorder-point"></a>The role of the reorder point
...
## <a name="monitoring-the-projected-inventory-level-and-the-reorder-point"></a><a name="monitoring-the-projected-inventory-level-and-the-reorder-point"></a><a name="monitoring-the-projected-inventory-level-and-the-reorder-point"></a>Monitoring the projected inventory level and the reorder point
...
### <a name="projected-inventory"></a><a name="projected-inventory"></a><a name="projected-inventory"></a>Projected inventory
...
### <a name="projected-available-inventory"></a><a name="projected-available-inventory"></a><a name="projected-available-inventory"></a>Projected available inventory
...
### <a name="time-buckets"></a><a name="time-buckets"></a><a name="time-buckets"></a>Time buckets
...
### <a name="determining-the-projected-inventory-level"></a><a name="determining-the-projected-inventory-level"></a><a name="determining-the-projected-inventory-level"></a>Determining the projected inventory level
...
## <a name="the-role-of-the-time-bucket"></a><a name="the-role-of-the-time-bucket"></a><a name="the-role-of-the-time-bucket"></a>The role of the time bucket
...
## <a name="stay-below-the-overflow-level"></a><a name="stay-below-the-overflow-level"></a><a name="stay-below-the-overflow-level"></a>Stay below the overflow level
...
### <a name="calculating-the-overflow-level"></a><a name="calculating-the-overflow-level"></a><a name="calculating-the-overflow-level"></a>Calculating the overflow level

The overflow level is calculated in different ways depending on the reordering policy.  

#### <a name="maximum-qty"></a><a name="maximum-qty"></a><a name="maximum-qty"></a>Maximum Qty.
...
#### <a name="fixed-reorder-qty"></a><a name="fixed-reorder-qty"></a><a name="fixed-reorder-qty"></a>Fixed Reorder Qty.
...
#### <a name="order-multiple"></a><a name="order-multiple"></a><a name="order-multiple"></a>Order multiple
...
### <a name="creating-the-planning-line-with-an-overflow-warning"></a><a name="creating-the-planning-line-with-an-overflow-warning"></a><a name="creating-the-planning-line-with-an-overflow-warning"></a>Creating the planning line with an overflow warning
...
#### <a name="calculating-the-planning-line-quantity"></a><a name="calculating-the-planning-line-quantity"></a><a name="calculating-the-planning-line-quantity"></a>Calculating the planning line quantity
...
#### <a name="defining-the-action-message-type"></a><a name="defining-the-action-message-type"></a><a name="defining-the-action-message-type"></a>Defining the action message type
...
#### <a name="composing-the-warning-message"></a><a name="composing-the-warning-message"></a><a name="composing-the-warning-message"></a>Composing the warning message
...
### <a name="example-scenario"></a><a name="example-scenario"></a><a name="example-scenario"></a>Example scenario
...
#### <a name="item-setup"></a><a name="item-setup"></a><a name="item-setup"></a>Item setup
...
#### <a name="situation-before-sales-decrease"></a><a name="situation-before-sales-decrease"></a><a name="situation-before-sales-decrease"></a>Situation before sales decrease
...
#### <a name="situation-after-sales-decrease"></a><a name="situation-after-sales-decrease"></a><a name="situation-after-sales-decrease"></a>Situation after sales decrease
...
#### <a name="resulting-planning-lines"></a><a name="resulting-planning-lines"></a><a name="resulting-planning-lines"></a>Resulting planning lines
...
## <a name="handling-projected-negative-inventory"></a><a name="handling-projected-negative-inventory"></a><a name="handling-projected-negative-inventory"></a>Handling projected negative inventory
...
### <a name="fixed-reorder-quantity"></a><a name="fixed-reorder-quantity"></a><a name="fixed-reorder-quantity"></a>Fixed Reorder Quantity
...
#### <a name="calculated-per-time-bucket"></a><a name="calculated-per-time-bucket"></a><a name="calculated-per-time-bucket"></a>Calculated per time bucket
...
#### <a name="creates-only-necessary-supply"></a><a name="creates-only-necessary-supply"></a><a name="creates-only-necessary-supply"></a>Creates only necessary supply
...
#### <a name="combines-with-order-modifiers"></a><a name="combines-with-order-modifiers"></a><a name="combines-with-order-modifiers"></a>Combines with order modifiers
...
#### <a name="combines-with-calendars"></a><a name="combines-with-calendars"></a><a name="combines-with-calendars"></a>Combines with calendars
...
#### <a name="shouldnt-be-used-with-forecasts"></a><a name="shouldnt-be-used-with-forecasts"></a><a name="shouldnt-be-used-with-forecasts"></a>Shouldn't be used with forecasts
...
#### <a name="must-not-be-used-with-reservations"></a><a name="must-not-be-used-with-reservations"></a><a name="must-not-be-used-with-reservations"></a>Must not be used with reservations
...
### <a name="maximum-quantity"></a><a name="maximum-quantity"></a><a name="maximum-quantity"></a>Maximum Quantity
...
#### <a name="calculate-per-time-bucket"></a><a name="calculate-per-time-bucket"></a><a name="calculate-per-time-bucket"></a>Calculate per time bucket
...
#### <a name="combine-with-order-modifiers"></a><a name="combine-with-order-modifiers"></a><a name="combine-with-order-modifiers"></a>Combine with order modifiers
...
### <a name="combine-with-calendars"></a><a name="combine-with-calendars"></a><a name="combine-with-calendars"></a>Combine with calendars
...
#### <a name="order-to-order-links-and-past-due-dates"></a><a name="order-to-order-links-and-past-due-dates"></a><a name="order-to-order-links-and-past-due-dates"></a>Order-to-order links and past due dates
