...
---
# <a name="design-details-handling-reordering-policies" />Design Details: Handling Reordering Policies
...
## <a name="the-role-of-the-reorder-point" />The role of the reorder point
...
## <a name="monitoring-the-projected-inventory-level-and-the-reorder-point" />Monitoring the projected inventory level and the reorder point
...
### <a name="projected-inventory" />Projected inventory
...
### <a name="projected-available-inventory" />Projected available inventory
...
### <a name="time-buckets" />Time buckets
...
### <a name="determining-the-projected-inventory-level" />Determining the projected inventory level
...
## <a name="the-role-of-the-time-bucket" />The role of the time bucket
...
## <a name="stay-below-the-overflow-level" />Stay below the overflow level
...
### <a name="calculating-the-overflow-level" />Calculating the overflow level

The overflow level is calculated in different ways depending on the reordering policy.  

#### <a name="maximum-qty" />Maximum Qty.
...
#### <a name="fixed-reorder-qty" />Fixed Reorder Qty.
...
#### <a name="order-multiple" />Order multiple
...
### <a name="creating-the-planning-line-with-an-overflow-warning" />Creating the planning line with an overflow warning
...
#### <a name="calculating-the-planning-line-quantity" />Calculating the planning line quantity
...
#### <a name="defining-the-action-message-type" />Defining the action message type
...
#### <a name="composing-the-warning-message" />Composing the warning message
...
### <a name="example-scenario" />Example scenario
...
#### <a name="situation-before-sales-decrease" />Situation before sales decrease
...
#### <a name="situation-after-sales-decrease" />Situation after sales decrease
...
#### <a name="resulting-planning-lines" />Resulting planning lines
...
## <a name="handling-projected-negative-inventory" />Handling projected negative inventory
...
### <a name="fixed-reorder-quantity" />Fixed Reorder Quantity
...
#### <a name="calculated-per-time-bucket" />Calculated per time bucket
...
#### <a name="creates-only-necessary-supply" />Creates only necessary supply
...
#### <a name="combines-with-order-modifiers" />Combines with order modifiers
...
#### <a name="combines-with-calendars" />Combines with calendars
...
#### <a name="shouldnt-be-used-with-forecasts" />Shouldn't be used with forecasts
...
#### <a name="must-not-be-used-with-reservations" />Must not be used with reservations
...
### <a name="maximum-quantity" />Maximum Quantity
...
#### <a name="calculate-per-time-bucket" />Calculate per time bucket
...
#### <a name="combine-with-order-modifiers" />Combine with order modifiers
...
### <a name="combine-with-calendars" />Combine with calendars
...
#### <a name="order-to-order-links-and-past-due-dates" />Order-to-order links and past due dates
