...
ms.author: edupont
---
# <a name="create-special-orders"></a><a name="create-special-orders"></a><a name="create-special-orders"></a>Create Special Orders
...
## <a name="to-create-a-special-order"></a><a name="to-create-a-special-order"></a><a name="to-create-a-special-order"></a>To create a special order
