...
# <a name="set-up-unrealized-vat-for-cash-based-accounting"></a>Set up unrealized VAT for cash-based accounting
...
| Percentage | Payments cover both VAT and the invoice amount in proportion to the payment's percentage of the remaining invoice amount. The paid GST amount is transferred from the unrealised GST account to the realised GST account. |
