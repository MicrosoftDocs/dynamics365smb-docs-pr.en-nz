...
ms.author: bholtorf
---
# <a name="synchronize-contacts-in-business-central-with-contacts-in-microsoft-outlook" />Synchronise Contacts in Business Central with Contacts in Microsoft Outlook
...
## <a name="set-up-synchronization" />Set Up Synchronisation
...
### <a name="automate-synchronization" />Automate synchronisation
...
## <a name="synchronize-contacts" />Synchronise Contacts
