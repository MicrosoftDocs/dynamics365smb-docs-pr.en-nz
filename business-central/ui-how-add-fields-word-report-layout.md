...
---
# <a name="work-with-word-layouts" /><a name="work-with-word-layouts"></a>Work with Word Layouts
...
## <a name="embedding-fonts-in-word-layouts-for-consistency" /><a name="embedding-fonts-in-word-layouts-for-consistency"></a>Embedding Fonts in Word Layouts for Consistency
...
## <a name="adding-data-fields" /><a name="adding-data-fields"></a>Adding data fields
...
### <a name="to-add-a-label-or-data-field" /><a name="to-add-a-label-or-data-field"></a>To add a label or data field
...
### <a name="to-add-repeating-rows-of-data-fields-to-create-a-list" /><a name="to-add-repeating-rows-of-data-fields-to-create-a-list"></a>To add repeating rows of data fields to create a list
...
## <a name="adding-image-fields" /><a name="adding-image-fields"></a>Adding image fields
...
### <a name="to-add-an-image" /><a name="to-add-an-image"></a>To add an image
...
### <a name="to-remove-a-label-or-data-field" /><a name="to-remove-a-label-or-data-field"></a>To remove a label or data field
...
## <a name="custom-xml-part-overview" /><a name="custom-xml-part-overview"></a>Custom XML Part Overview
...
### <a name="xml-structure-of-custom-xml-part" /><a name="xml-structure-of-custom-xml-part"></a>XML structure of custom XML part
...
### <a name="custom-xml-part-in-word" /><a name="custom-xml-part-in-word"></a>Custom XML part in Word
