...
ms.author: edupont
---
# <a name="enable-approval-workflows"></a><a name="enable-approval-workflows"></a>Enable Approval Workflows
...
## <a name="enable-a-workflow"></a><a name="enable-a-workflow"></a>Enable a workflow
