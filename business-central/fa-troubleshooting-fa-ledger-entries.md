...
ms.author: bholtorf
---
# <a name="the-troubleshooting-fa-ledger-entries-extension"></a><a name="the-troubleshooting-fa-ledger-entries-extension"></a>The Troubleshooting FA Ledger Entries Extension
...
## <a name="troubleshooting-fixed-asset-ledger-entries"></a><a name="troubleshooting-fixed-asset-ledger-entries"></a>Troubleshooting Fixed Asset Ledger Entries
