...
ms.author: bholtorf
---
# <a name="the-troubleshooting-fa-ledger-entries-extension" />The Troubleshooting FA Ledger Entries Extension
...
## <a name="troubleshooting-fixed-asset-ledger-entries" />Troubleshooting Fixed Asset Ledger Entries
