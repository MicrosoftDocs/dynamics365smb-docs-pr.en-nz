...
# <a name="work-with-catalog-items" />Work with Catalogue Items
...
## <a name="create-a-catalog-item" />Create a catalogue item
...
## <a name="specify-how-catalog-item-numbers-are-converted-to-your-own-numbering" />Specify how catalogue item numbers are converted to your own numbering
...
## <a name="convert-a-catalog-item-to-a-normal-item" />Convert a catalogue item to a normal item
...
## <a name="to-sell-a-catalog-item-and-convert-it-to-a-normal-item" />To sell a catalogue item and convert it to a normal item
