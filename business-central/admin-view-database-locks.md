...
ms.author: jswymer
---
# <a name="viewing-database-locks"></a><a name="viewing-database-locks"></a>Viewing Database Locks
...
## <a name="to-view-database-locks"></a><a name="to-view-database-locks"></a>To view database locks
