...
---
# <a name="monitor-job-progress-and-performance" />Monitor Job Progress and Performance
...
## <a name="create-a-job-wip-method" />Create a job WIP method
...
## <a name="define-a-wip-method-for-a-job" />Define a WIP method for a job
...
### <a name="define-a-wip-method-for-a-job-task" />Define a WIP method for a job task
...
## <a name="calculate-wip" />Calculate WIP
...
## <a name="calculate-and-post-job-completion-entries" />Calculate and post job completion entries
...
## <a name="view-job-ledger-entries" />View job ledger entries
