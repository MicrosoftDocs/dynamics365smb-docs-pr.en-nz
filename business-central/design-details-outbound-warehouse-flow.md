...
### <a name="1-release-a-source-document"></a>1: Release a source document
...
### <a name="2-create-an-inventory-pick"></a>2: Create an inventory pick
...
### <a name="3-post-an-inventory-pick"></a>3: Post an inventory pick
...
### <a name="1-release-a-source-document-1"></a>1: Release a source document
...
### <a name="2-create-a-warehouse-shipment"></a>2: Create a warehouse shipment
...
### <a name="3-create-a-warehouse-pick"></a>3: Create a warehouse pick
...
### <a name="4-register-a-warehouse-pick"></a>4: Register a warehouse pick
...
### <a name="5-post-the-warehouse-shipment"></a>5: Post the warehouse shipment
