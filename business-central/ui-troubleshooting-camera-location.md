...
# <a name="troubleshooting-accessing-camera-and-location"></a><a name="troubleshooting-accessing-camera-and-location"></a>Troubleshooting: Accessing Camera and Location
...
## <a name="device-must-have-camera-and-location-capabilities"></a><a name="device-must-have-camera-and-location-capabilities"></a>Device must have Camera and Location Capabilities
...
## <a name="access-permissions-not-enabled"></a><a name="access-permissions-not-enabled"></a>Access Permissions not Enabled
...
## <a name="web-client-connection-not-secure"></a><a name="web-client-connection-not-secure"></a>Web Client Connection not Secure
...
## <a name="work-with-virtualization-technologies"></a><a name="work-with-virtualization-technologies"></a>Work with Virtualization Technologies
...
## <a name="antivirus-software"></a><a name="antivirus-software"></a>Antivirus Software
