...
### <a name="can-i-convert-the-trial-to-a-paid-license" />Can I convert the trial to a paid licence?

Yes, you can! For more information, see [Get Started with a Subscription](trial-signup.md#get-started-with-a-subscription).  

### <a name="what-are-the-trial-limits-and-quotas" />What are the trial limits and quotas?
...
### <a name="how-do-i-start-using-the-trial" />How do I start using the trial?
...
### <a name="what-features-are-available-in-the-trial" />What features are available in the trial?
...
### <a name="how-long-does-the-trial-last" />How long does the trial last?
...
### <a name="how-do-i-remove-sample-data-from-the-trial" />How do I remove sample data from the trial?
...
### <a name="how-do-i-restore-sample-data" />How do I restore sample data?
