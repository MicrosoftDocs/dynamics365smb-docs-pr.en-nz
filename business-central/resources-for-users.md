...
# <a name="resources-for-users"></a>Resources for Users
...
## <a name="hot-topics-right-now"></a>Hot topics right now

- Register for the [!INCLUDE [prod_short](includes/prod_short.md)] Launch Event on [aka.ms/BCLE](https://aka.ms/BCLE)

## <a name="latest-release-and-updates"></a>Latest release and updates
...
## <a name="stay-up-to-date-on-whats-new"></a>Stay up to date on what's new

- Watch the [!INCLUDE [prod_short](includes/prod_short.md)] Launch Event sessions: [aka.ms/BCLE](https://aka.ms/BCLE) 

## <a name="social-and-blogs"></a>Social and blogs
...
## <a name="customer-onboarding-and-resources"></a>Customer onboarding and resources
...
## <a name="reporting-and-business-intelligence"></a>Reporting and business intelligence
...
## <a name="migrating-from-on-premises-to-online"></a>Migrating from on-premises to online
...
## <a name="telemetry-and-performance"></a>Telemetry and performance
...
## <a name="security-privacy-and-compliance"></a>Security, privacy, and compliance
...
## <a name="licensing-and-pricing"></a>Licensing and pricing
...
## <a name="events-for-customers"></a>Events for customers
