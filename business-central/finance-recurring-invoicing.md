...
ms.author: andreipa
---
# <a name="work-with-recurring-revenue-in-"></a><a name="work-with-recurring-revenue-in-"></a>Work with recurring revenue in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="register-revenue-with-a-recurring-general-journal"></a><a name="register-revenue-with-a-recurring-general-journal"></a>Register revenue with a recurring general journal
...
### <a name="why-use-this-option"></a><a name="why-use-this-option"></a>Why use this option
...
## <a name="create-multiple-invoices-based-on-a-recurring-job-journal"></a><a name="create-multiple-invoices-based-on-a-recurring-job-journal"></a>Create multiple invoices based on a recurring job journal
...
### <a name="why-use-this-option-1"></a><a name="why-use-this-option-1"></a>Why use this option
...
## <a name="create-multiple-invoices-based-on-recurring-sales-lines"></a><a name="create-multiple-invoices-based-on-recurring-sales-lines"></a>Create multiple invoices based on recurring sales lines
...
### <a name="why-use-this-option-2"></a><a name="why-use-this-option-2"></a>Why use this option
...
## <a name="recurring-invoices-with-service-contract"></a><a name="recurring-invoices-with-service-contract"></a>Recurring invoices with service contract
...
### <a name="why-use-this-option-3"></a><a name="why-use-this-option-3"></a>Why use this option
...
## <a name="related-features"></a><a name="related-features"></a>Related features
There are several related capabilities in [!INCLUDE[prod_short](includes/prod_short.md)].

### <a name="blanket-sales-orders"></a><a name="blanket-sales-orders"></a>Blanket sales orders
...
#### <a name="why-use-this-option-4"></a><a name="why-use-this-option-4"></a>Why use this option
...
### <a name="recurring-orders-norway"></a><a name="recurring-orders-norway"></a>Recurring Orders (Norway)
...
#### <a name="why-use-this-option-5"></a><a name="why-use-this-option-5"></a>Why use this option
...
### <a name="recurring-revenue-and-subscription-billing-by-other-providers"></a><a name="recurring-revenue-and-subscription-billing-by-other-providers"></a>Recurring revenue and subscription billing by other providers
