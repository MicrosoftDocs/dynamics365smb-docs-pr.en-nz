...
---
# <a name="work-with-recurring-revenue-in-"></a>Work with recurring revenue in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="create-multiple-invoices-based-on-a-recurring-project-journal"></a>Create multiple invoices based on a recurring project journal
...
### <a name="why-use-this-option-1"></a>Why use this option
...
### <a name="why-use-this-option-2"></a>Why use this option
...
### <a name="why-use-this-option-3"></a>Why use this option
...
#### <a name="why-use-this-option-4"></a>Why use this option
...
#### <a name="why-use-this-option-5"></a>Why use this option
