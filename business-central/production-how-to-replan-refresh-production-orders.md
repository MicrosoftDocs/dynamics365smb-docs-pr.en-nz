...
ms.author: edupont
---
# <a name="replan-or-refresh-production-orders-directly" />Replan or Refresh Production Orders Directly
...
## <a name="to-replan-a-production-order" />To replan a production order
...
## <a name="to-refresh-a-production-order" />To refresh a production order
