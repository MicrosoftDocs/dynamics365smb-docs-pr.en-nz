...
#### <a name="save-or-discard-proposed-matches"></a>Save or discard proposed matches
...
## <a name="post-unmatched-bank-transaction-amounts-to-suggested-general-ledger-accounts"></a>Post unmatched bank transaction amounts to suggested general ledger accounts
