...
ms.author: jswymer
---
# <a name="use-business-central-as-your-business-inbox-in-outlook" />Use Business Central as your Business Inbox in Outlook
...
## <a name="work-with-contacts-and-documents-using-the-contact-insights-add-in" />Work with contacts and documents using the Contact Insights add-in
...
### <a name="look-up-a-business-contact-when-composing-an-email" />Look up a business contact when composing an email
...
### <a name="view-and-change-the-contact-details-or-switch-company" />View and change the contact details or switch company
...
### <a name="track-incoming-documents" />Track incoming documents
...
### <a name="create-and-send-new-document-to-a-contact" />Create and send new document to a contact
...
### <a name="attach-files-to-records" />Attach files to records
...
#### <a name="how-to-attach-a-file" />How to attach a file
...
## <a name="view-a-document-from-an-email-using-the-document-view-add-in" />View a document from an email using the Document View add-in
...
## <a name="see-related-microsoft-trainingtrainingmodulesalternative-interfaces-dynamics--business-centralindex" />See related [Microsoft training](/training/modules/alternative-interfaces-dynamics-365-business-central/index)
