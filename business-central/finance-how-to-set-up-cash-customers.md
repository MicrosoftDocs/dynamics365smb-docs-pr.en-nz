...
ms.author: edupont
---
# <a name="set-up-cash-customers"></a><a name="set-up-cash-customers"></a>Set Up Cash Customers
...
## <a name="to-set-up-a-cash-customer"></a><a name="to-set-up-a-cash-customer"></a>To set up a cash customer
