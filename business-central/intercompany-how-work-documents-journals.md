...
## <a name="fill-in-and-send-an-intercompany-sales-order"></a>Fill in and send an intercompany sales order
...
## <a name="fill-in-and-post-an-intercompany-journal"></a>Fill in and post an intercompany journal
