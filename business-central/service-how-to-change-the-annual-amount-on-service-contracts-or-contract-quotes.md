...
ms.author: bholtorf
---
# <a name="change-the-annual-amount-on-service-contracts-or-contract-quotes" />Change the Annual Amount on Service Contracts or Contract Quotes
...
## <a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote" />To change the annual amount of the service contract or contract quote
...
## <a name="distributing-differences-between-new-and-calculated-annual-amounts" />Distributing Differences Between New and Calculated Annual Amounts
...
### <a name="even-distribution" />Even Distribution
...
### <a name="distribution-based-on-line-amount" />Distribution Based on Line Amount
...
### <a name="distribution-based-on-profit" />Distribution Based on Profit
