...
ms.author: solsen
---
# <a name="preview-posting-results" />Preview Posting Results
...
## <a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice" />To preview G/L entries that will result from posting a purchase invoice
