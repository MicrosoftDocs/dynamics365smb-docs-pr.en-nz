...
# <a name="set-up-calculations-and-posting-methods-for-value-added-tax" />Set Up Calculations and Posting Methods for Goods and Services Tax
...
## <a name="set-up-vat-using-the-assisted-setup-guide-recommended" />Set up GST using the assisted setup guide (recommended)
...
### <a name="check-the-vat-posting-setup" />Check the GST posting setup
...
## <a name="set-up-a-default-vat-date-for-documents-and-journals" />Set up a default GST date for documents and journals
...
### <a name="enabling-or-disabling-the-vat-date-feature" />Enabling or disabling the GST Date feature
...
### <a name="limiting-periods-for-posting-and-changing-the-vat-date" />Limiting periods for posting and changing the GST date
...
#### <a name="to-limit-posting-based-on-vat-return-period" />To limit posting based on GST return period
...
## <a name="set-up-vat-registration-numbers-for-your-country-or-region" />Set up GST registration numbers for your country or region
...
## <a name="set-up-vat-business-posting-groups" />Set up GST business posting groups
...
## <a name="set-up-vat-product-posting-groups" />Set up GST product posting groups
...
## <a name="combine-vat-posting-groups-in-vat-posting-setups" />Combine GST posting groups in GST posting setups
...
## <a name="assign-vat-posting-groups-by-default-to-multiple-entities" />Assign GST posting groups by default to multiple entities
...
## <a name="assign-vat-posting-groups-to-accounts-customers-vendors-items-and-resources" />Assign GST posting groups to accounts, customers, vendors, items, and resources

The following sections describe how to assign GST posting groups to individual entities.

### <a name="to-assign-vat-posting-groups-to-individual-general-ledger-accounts" />To assign GST posting groups to individual general ledger accounts
...
### <a name="to-assign-vat-business-posting-groups-to-customers-and-vendors" />To assign GST business posting groups to customers and vendors
...
### <a name="to-assign-vat-product-posting-groups-to-individual-items-and-resources" />To assign GST product posting groups to individual items and resources
...
## <a name="set-up-clauses-to-explain-vat-exemption-or-non-standard-vat-rates" />Set up clauses to explain GST exemption or non-standard GST rates
...
### <a name="to-set-up-vat-clauses" />To set up GST clauses
...
### <a name="to-assign-a-vat-clause-to-a-vat-posting-setup" />To assign a GST clause to a GST posting setup
...
### <a name="to-specify-translations-for-vat-clauses" />To specify translations for GST clauses
...
### <a name="to-specify-extended-text-for-vat-clauses" />To specify extended text for GST clauses
...
## <a name="create-a-vat-posting-setup-to-handle-import-vat" />Create a GST posting setup to handle Import GST
...
## <a name="use-reverse-charge-vat-for-trade-between-eu-countries-or-regions" />Use reverse charge GST for trade between EU countries or regions
...
## <a name="vat-rounding-for-documents" />GST rounding for documents
...
## <a name="set-up-vat-reporting" />Set up GST reporting
