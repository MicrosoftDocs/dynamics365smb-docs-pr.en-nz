...
# <a name="set-up-calculations-and-posting-methods-for-value-added-tax"></a><a name="set-up-calculations-and-posting-methods-for-value-added-tax"></a><a name="set-up-calculations-and-posting-methods-for-value-added-tax"></a>Set Up Calculations and Posting Methods for Goods and Services Tax
...
## <a name="set-up-vat-using-the-assisted-setup-guide-recommended"></a><a name="set-up-vat-using-the-assisted-setup-guide-recommended"></a><a name="set-up-vat-using-the-assisted-setup-guide-recommended"></a>Set up GST using the assisted setup guide (recommended)
...
### <a name="check-the-vat-posting-setup"></a><a name="check-the-vat-posting-setup"></a><a name="check-the-vat-posting-setup"></a>Check the GST posting setup
...
## <a name="set-up-a-default-vat-date-for-documents-and-journals"></a><a name="set-up-a-default-vat-date-for-documents-and-journals"></a><a name="set-up-a-default-vat-date-for-documents-and-journals"></a>Set up a default GST date for documents and journals
...
### <a name="enabling-or-disabling-the-vat-date-feature"></a><a name="enabling-or-disabling-the-vat-date-feature"></a><a name="enabling-or-disabling-the-vat-date-feature"></a>Enabling or disabling the GST Date feature

Some countries require that businesses use a specific GST date, but other countries don't. Some countries also require businesses to change the GST date in specific situations after they have posted documents, but other countries don't allow changes to GST dates. To allow for different contexts, you can choose whether you want to use this functionality and, if so, to what degree.
...
### <a name="limiting-periods-for-posting-and-changing-the-vat-date"></a><a name="limiting-periods-for-posting-and-changing-the-vat-date"></a><a name="limiting-periods-for-posting-and-changing-the-vat-date"></a>Limiting periods for posting and changing the GST date
...
#### <a name="to-limit-posting-based-on-vat-return-period"></a><a name="to-limit-posting-based-on-vat-return-period"></a><a name="to-limit-posting-based-on-vat-return-period"></a>To limit posting based on GST return period
...
## <a name="set-up-vat-registration-numbers-for-your-country-or-region"></a><a name="set-up-vat-registration-numbers-for-your-country-or-region"></a><a name="set-up-vat-registration-numbers-for-your-country-or-region"></a>Set up GST registration numbers for your country or region
...
## <a name="set-up-vat-business-posting-groups"></a><a name="set-up-vat-business-posting-groups"></a><a name="set-up-vat-business-posting-groups"></a>Set up GST business posting groups
...
## <a name="set-up-vat-product-posting-groups"></a><a name="set-up-vat-product-posting-groups"></a><a name="set-up-vat-product-posting-groups"></a>Set up GST product posting groups
...
## <a name="combine-vat-posting-groups-in-vat-posting-setups"></a><a name="combine-vat-posting-groups-in-vat-posting-setups"></a><a name="combine-vat-posting-groups-in-vat-posting-setups"></a>Combine GST posting groups in GST posting setups
...
## <a name="assign-vat-posting-groups-by-default-to-multiple-entities"></a><a name="assign-vat-posting-groups-by-default-to-multiple-entities"></a><a name="assign-vat-posting-groups-by-default-to-multiple-entities"></a>Assign GST posting groups by default to multiple entities
...
## <a name="assign-vat-posting-groups-to-accounts-customers-vendors-items-and-resources"></a><a name="assign-vat-posting-groups-to-accounts-customers-vendors-items-and-resources"></a><a name="assign-vat-posting-groups-to-accounts-customers-vendors-items-and-resources"></a>Assign GST posting groups to accounts, customers, vendors, items, and resources

The following sections describe how to assign GST posting groups to individual entities.

### <a name="to-assign-vat-posting-groups-to-individual-general-ledger-accounts"></a><a name="to-assign-vat-posting-groups-to-individual-general-ledger-accounts"></a><a name="to-assign-vat-posting-groups-to-individual-general-ledger-accounts"></a>To assign GST posting groups to individual general ledger accounts
...
### <a name="to-assign-vat-business-posting-groups-to-customers-and-vendors"></a><a name="to-assign-vat-business-posting-groups-to-customers-and-vendors"></a><a name="to-assign-vat-business-posting-groups-to-customers-and-vendors"></a>To assign GST business posting groups to customers and vendors
...
### <a name="to-assign-vat-product-posting-groups-to-individual-items-and-resources"></a><a name="to-assign-vat-product-posting-groups-to-individual-items-and-resources"></a><a name="to-assign-vat-product-posting-groups-to-individual-items-and-resources"></a>To assign GST product posting groups to individual items and resources
...
## <a name="set-up-clauses-to-explain-vat-exemption-or-non-standard-vat-rates"></a><a name="set-up-clauses-to-explain-vat-exemption-or-non-standard-vat-rates"></a><a name="set-up-clauses-to-explain-vat-exemption-or-non-standard-vat-rates"></a>Set up clauses to explain GST exemption or non-standard GST rates
...
### <a name="to-set-up-vat-clauses"></a><a name="to-set-up-vat-clauses"></a><a name="to-set-up-vat-clauses"></a>To set up GST clauses
...
### <a name="to-assign-a-vat-clause-to-a-vat-posting-setup"></a><a name="to-assign-a-vat-clause-to-a-vat-posting-setup"></a><a name="to-assign-a-vat-clause-to-a-vat-posting-setup"></a>To assign a GST clause to a GST posting setup
...
### <a name="to-specify-translations-for-vat-clauses"></a><a name="to-specify-translations-for-vat-clauses"></a><a name="to-specify-translations-for-vat-clauses"></a>To specify translations for GST clauses
...
### <a name="to-specify-extended-text-for-vat-clauses"></a><a name="to-specify-extended-text-for-vat-clauses"></a><a name="to-specify-extended-text-for-vat-clauses"></a>To specify extended text for GST clauses
...
## <a name="create-a-vat-posting-setup-to-handle-import-vat"></a><a name="create-a-vat-posting-setup-to-handle-import-vat"></a><a name="create-a-vat-posting-setup-to-handle-import-vat"></a>Create a GST posting setup to handle Import GST
...
## <a name="use-reverse-charge-vat-for-trade-between-eu-countries-or-regions"></a><a name="use-reverse-charge-vat-for-trade-between-eu-countries-or-regions"></a><a name="use-reverse-charge-vat-for-trade-between-eu-countries-or-regions"></a>Use reverse charge GST for trade between EU countries or regions
...
## <a name="vat-rounding-for-documents"></a><a name="vat-rounding-for-documents"></a><a name="vat-rounding-for-documents"></a>GST rounding for documents
...
## <a name="set-up-vat-reporting"></a><a name="set-up-vat-reporting"></a><a name="set-up-vat-reporting"></a>Set up GST reporting
