...
ms.author: jswymer
---
# <a name="set-up-opportunity-sales-cycles-and-cycle-stages" />Set Up Opportunity Sales Cycles and Cycle Stages
...
## <a name="to-set-up-opportunity-sales-cycle-codes" />To set up opportunity sales cycle codes
...
## <a name="to-define-opportunity-sales-cycle-stages" />To define opportunity sales cycle stages
...
## <a name="to-assign-stage-cycles-to-opportunities" />To assign stage cycles to opportunities
...
## <a name="to-set-up-activities-with-tasks" />To set up activities with tasks
...
## <a name="to-assign-tasks-or-activities-of-tasks-to-opportunities" />To assign tasks or activities of tasks to opportunities
