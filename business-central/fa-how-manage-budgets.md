...
ms.author: edupont
---
# <a name="manage-budgets-for-fixed-assets" />Manage Budgets for Fixed Assets
...
## <a name="to-budget-the-acquisition-cost-of-a-fixed-asset" />To budget the acquisition cost of a fixed asset
...
## <a name="to-budget-the-disposal-of-a-fixed-asset" />To budget the disposal of a fixed asset
...
## <a name="to-view-projected-disposal-values" />To view projected disposal values
...
## <a name="to-budget-depreciation" />To budget depreciation
