...
ms.author: edupont
---
# <a name="request-quotes" />Request Quotes
...
## <a name="create-a-purchase-quote" />Create a purchase quote
...
## <a name="convert-a-purchase-quote-to-a-purchase-order" />Convert a purchase quote to a purchase order
...
## <a name="see-related-microsoft-trainingtrainingmodulescreate-purchase-documents-dynamics--business-central" />See related [Microsoft training](/training/modules/create-purchase-documents-dynamics-365-business-central/).
