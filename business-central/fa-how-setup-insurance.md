...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance" />Set Up Fixed Asset Insurance
...
## <a name="to-set-up-general-insurance-information" />To set up general insurance information
...
## <a name="to-set-up-insurance-types" />To set up insurance types
...
## <a name="to-set-up-insurance-cards" />To set up insurance cards
...
## <a name="to-set-up-insurance-journal-templates" />To set up insurance journal templates
...
## <a name="to-set-up-insurance-journal-batches" />To set up insurance journal batches
