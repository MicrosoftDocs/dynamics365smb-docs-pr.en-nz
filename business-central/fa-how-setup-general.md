...
ms.author: edupont
---
# <a name="set-up-general-fixed-assets-information" />Set Up General Fixed Assets Information
...
## <a name="to-set-up-general-default-values-for-fixed-assets" />To set up general default values for fixed assets
...
## <a name="to-set-up-fixed-asset-posting-groups" />To set up fixed asset posting groups
...
## <a name="to-set-up-fixed-asset-allocation-keys" />To set up fixed asset allocation keys
...
## <a name="to-set-up-fixed-asset-journal-templates" />To set up fixed asset journal templates
...
## <a name="to-set-up-fixed-asset-journal-batches" />To set up fixed asset journal batches
...
## <a name="to-set-up-fixed-asset-reclassification-journal-templates" />To set up fixed asset reclassification journal templates
...
## <a name="to-set-up-fixed-asset-reclassification-journal-batches" />To set up fixed asset reclassification journal batches
...
## <a name="to-set-up-fixed-asset-class-codes" />To set up fixed asset class codes
...
## <a name="to-set-up-fixed-asset-subclass-codes" />To set up fixed asset subclass codes
...
## <a name="to-set-up-fixed-asset-location-codes" />To set up fixed asset location codes
...
## <a name="to-register-opening-entries" />To register opening entries
