...
## <a name="to-set-up-general-behavior-for-fixed-assets-functionality"></a>To set up general behaviour for fixed assets functionality
...
## <a name="to-set-up-fixed-asset-class-and-subclass-codes"></a>To set up fixed asset class and subclass codes
...
### <a name="fixed-asset-class-codes"></a>Fixed asset class codes
...
### <a name="fixed-asset-subclass-codes"></a>Fixed asset subclass codes
...
## <a name="start-to-register-assets"></a>Start to register assets
...
## <a name="to-set-up-fixed-asset-location-codes-optional"></a>To set up fixed asset location codes (optional)
...
## <a name="to-set-up-fixed-asset-allocation-keys-optional"></a>To set up fixed asset allocation keys (optional)
...
## <a name="to-set-up-fixed-asset-journal-batches-optional"></a>To set up fixed asset journal batches (optional)
...
## <a name="to-set-up-fixed-asset-reclassification-journal-templates-optional"></a>To set up fixed asset reclassification journal templates (optional)
...
## <a name="to-set-up-fixed-asset-reclassification-journal-batches-optional"></a>To set up fixed asset reclassification journal batches (optional)
