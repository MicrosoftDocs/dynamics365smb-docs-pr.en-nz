...
ms.author: edupont
---
# <a name="update-currency-exchange-rates" />Update Currency Exchange Rates
...
### <a name="effect-on-customers-and-vendors" />Effect on Customers and Vendors
...
#### <a name="dimensions-on-customer-and-vendor-ledger-entries" />Dimensions on Customer and Vendor Ledger Entries
...
### <a name="effect-on-bank-accounts" />Effect on Bank Accounts
...
#### <a name="dimensions-on-bank-account-entries" />Dimensions on Bank Account Entries
...
### <a name="effect-on-gl-accounts" />Effect on G/L Accounts
...
##### <a name="dimensions-on-gl-account-entries" />Dimensions on G/L Account Entries
...
## <a name="to-set-up-a-currency-exchange-rate-service" />To set up a currency exchange rate service
...
## <a name="to-update-currency-exchange-rates-through-a-service" />To update currency exchange rates through a service
