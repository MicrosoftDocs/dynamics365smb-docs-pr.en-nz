...
# <a name="suggest-lines-on-sales-documents-with-copilot-preview"></a>Suggest lines on sales documents with Copilot (preview)
...
## <a name="about-sales-line-suggestions-with-copilot"></a>About sales line suggestions with Copilot
...
## <a name="available-languages"></a>Prerequisites
...
## <a name="prerequisites"></a>Geographic availability
...
## <a name="examples-of-prompts"></a>Examples of prompts
...
### <a name="sample-inquiry-to-repeat-the-past-document"></a>Sample inquiry to repeat the past document

Prompt: *Need all the products from invoice 103031*

### <a name="during-phone-call-user-quickly-types-list-of-required-products-and-quantities-not-always-accurate-enough-or-using-internal-product-names"></a>During phone call user quickly types list of required products and quantities, not always accurate enough or using internal product names

Prompt: *2 Red Kids Biicycle*

Note that the prompt works, even with multiple typos.

### <a name="a-user-copies-an-inquiry-from-an-inbound-communication-and-pastes-it-to-the-sales-lines-suggestions-page"></a>A user copies an inquiry from an inbound communication and pastes it to the Sales Lines Suggestions page
...
## <a name="suggest-lines-on-a-sales-document"></a>Suggest lines on a sales document
...
## <a name="review-save-discard-or-regenerate-suggestions"></a>Review, save, discard, or regenerate suggestions
