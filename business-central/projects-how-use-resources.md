...
ms.author: edupont
---
# <a name="use-resources-for-jobs" />Use Resources for Jobs
...
## <a name="to-assign-resources-to-jobs" />To assign resources to jobs
...
## <a name="to-record-resource-usage-for-a-job" />To record resource usage for a job
...
## <a name="to-adjust-resource-prices" />To adjust resource prices
...
## <a name="to-get-resource-price-change-suggestions-based-on-existing-alternate-prices" />To get resource price change suggestions based on existing alternate prices
...
## <a name="to-get-resource-price-change-suggestions-based-on-standard-prices" />To get resource price change suggestions based on standard prices
...
## <a name="to-get-resource-price-change-suggestions-based-on-alternate-prices" />To get resource price change suggestions based on alternate prices
