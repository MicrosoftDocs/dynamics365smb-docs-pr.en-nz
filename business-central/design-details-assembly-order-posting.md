...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting"></a><a name="design-details-assembly-order-posting"></a>Design Details: Assembly Order Posting
...
## <a name="posting-sequence"></a><a name="posting-sequence"></a>Posting Sequence
...
## <a name="cost-adjustment"></a><a name="cost-adjustment"></a>Cost Adjustment
...
### <a name="performing-the-adjustment"></a><a name="performing-the-adjustment"></a>Performing the Adjustment
...
### <a name="posting-dates"></a><a name="posting-dates"></a>Posting dates
