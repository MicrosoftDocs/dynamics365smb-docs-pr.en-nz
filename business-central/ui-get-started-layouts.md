...
ms.author: jswymer
---
# <a name="get-started-creating-report-layouts"></a><a name="get-started-creating-report-layouts"></a>Get Started Creating Report Layouts
...
## <a name="decide-what-type-of-layout-you-want"></a><a name="decide-what-type-of-layout-you-want"></a><a name="decide"></a>Decide what type of layout you want
...
## <a name="create-a-new-layout"></a><a name="create-a-new-layout"></a><a name="create"></a>Create a new layout
...
## <a name="modify-a-layout"></a><a name="modify-a-layout"></a><a name="modify"></a>Modify a layout
...
## <a name="replace-a-layout"></a><a name="replace-a-layout"></a><a name="replace"></a>Replace a layout
...
## <a name="rename-a-layout"></a><a name="rename-a-layout"></a><a name="rename"></a>Rename a layout
