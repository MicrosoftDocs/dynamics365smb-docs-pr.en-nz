...
---
# <a name="use-power-automate-flows-in-" />Use Power Automate Flows in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="see-related-microsoft-training" />See related [Microsoft training](/training/modules/use-power-automate/)
