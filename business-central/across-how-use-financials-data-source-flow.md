...
---
# <a name="use-power-automate-flows-in-includeprodshortincludesprodshortmd" />Use Power Automate Flows in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="about-power-automate-flows" />About Power Automate flows
...
## <a name="power-automate-features" />Power Automate features
...
## <a name="run-instant-flows" />Run instant flows
...
## <a name="create-edit-and-manage-flows" />Create, edit, and manage flows
...
## <a name="see-related-microsoft-trainingtrainingmodulesuse-power-automate" />See related [Microsoft training](/training/modules/use-power-automate/)
