...
---
# <a name="use-power-automate-flows-in-"></a><a name="use-power-automate-flows-in-"></a><a name="use-power-automate-flows-in-"></a>Use Power Automate Flows in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="about-power-automate-flows"></a><a name="about-power-automate-flows"></a><a name="about-power-automate-flows"></a>About Power Automate flows
...
## <a name="power-automate-features"></a><a name="power-automate-features"></a><a name="power-automate-features"></a>Power Automate features
...
## <a name="run-instant-flows"></a><a name="run-instant-flows"></a><a name="run-instant-flows"></a>Run instant flows
...
## <a name="create-edit-and-manage-flows"></a><a name="create-edit-and-manage-flows"></a><a name="create-edit-and-manage-flows"></a>Create, edit, and manage flows
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>See related [Microsoft training](/training/modules/use-power-automate/)
