...
## <a name="to-set-up-a-document-sending-profile" />To set up a document sending profile
...
## <a name="to-specify-a-sending-profile-on-a-customer-card" />To specify a sending profile on a customer card
