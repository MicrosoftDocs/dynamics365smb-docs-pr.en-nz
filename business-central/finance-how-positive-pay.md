...
## <a name="to-view-exported-positive-pay-records"></a>To view exported Positive Pay records
...
## <a name="to-reexport-positive-pay-files"></a>To reexport Positive Pay files
