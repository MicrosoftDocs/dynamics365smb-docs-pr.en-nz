...
## <a name="to-restore-a-non-posted-sales-document-or-a-project-from-the-archive"></a>To restore a non-posted sales order from the archive
...
## <a name="to-delete-archived-versions"></a>To delete archived sales orders
