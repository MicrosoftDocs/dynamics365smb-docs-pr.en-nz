...
---
# <a name="project-reports-and-analytics-in-business-central" /><a name="project-reports-and-analytics-in-business-central"></a>Project Reports and Analytics in Business Central
...
## <a name="reports" /><a name="reports"></a>Reports
[!INCLUDE [project_reports](includes/project-reports-include.md)]

## <a name="tasks" /><a name="tasks"></a>Tasks
