...
ms.author: edupont
---
# <a name="analyze-actual-amounts-versus-budgeted-amounts" />Analyse Actual Amounts Versus Budgeted Amounts
...
## <a name="view-a-gl-budget" />View a G/L budget
...
## <a name="view-actual-and-budgeted-amounts-for-all-accounts" />View actual and budgeted amounts for all accounts
...
## <a name="to-view-actual-and-budgeted-amounts-for-several-periods" />To view actual and budgeted amounts for several periods
...
## <a name="see-related-training-at-microsoft-learnlearnmodulesbudgets-exchange-rates-dynamics-365-business-centralindex" />See related training at [Microsoft Learn](/learn/modules/budgets-exchange-rates-dynamics-365-business-central/index).
