...
## <a name="add-new-customers"></a>Adding new customers
...
## <a name="delete-customer-cards"></a>Deleting customer cards
...
## <a name="manage-credit-limits"></a>Managing credit limits
