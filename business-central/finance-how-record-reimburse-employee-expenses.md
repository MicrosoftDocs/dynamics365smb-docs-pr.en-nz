...
ms.author: edupont
---
# <a name="record-and-reimburse-employees-expenses" />Record and Reimburse Employees' Expenses
...
## <a name="to-record-an-employees-expense" />To record an employee's expense
...
## <a name="to-reimburse-an-employee" />To reimburse an employee
...
## <a name="to-reconcile-reimbursements-with-employee-ledger-entries" />To reconcile reimbursements with employee ledger entries
