...
ms.author: edupont
---
# <a name="delivery-date-calculation-for-sales" />Delivery Date Calculation for Sales
...
## <a name="calculating-a-requested-delivery-date" />Calculating a requested delivery date
...
## <a name="calculating-the-earliest-possible-delivery-date" />Calculating the earliest possible delivery date
