...
## <a name="switch-on-the-image-analyzer-extension"></a><a name="switch-on-the-image-analyzer-extension"></a><a name="switch-on-the-image-analyzer-extension"></a>Switch on the Image Analyzer extension
...
## <a name="analyze-an-item-image"></a><a name="analyze-an-item-image"></a><a name="analyze-an-item-image"></a>Analyze an item image
...
## <a name="analyze-a-contact-person-picture"></a><a name="analyze-a-contact-person-picture"></a><a name="analyze-a-contact-person-picture"></a>Analyze a contact person picture
...
## <a name="stop-using-the-image-analyzer-extension"></a><a name="stop-using-the-image-analyzer-extension"></a><a name="stop-using-the-image-analyzer-extension"></a>Stop using the Image Analyzer extension
