...
## <a name="analyze-an-item-image"></a><a name="analyze-an-item-image"></a>Analyze an item image
...
## <a name="analyze-a-contact-person-picture"></a><a name="analyze-a-contact-person-picture"></a>Analyze a contact person picture
