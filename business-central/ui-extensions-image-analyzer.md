...
## <a name="switch-on-the-image-analyzer-extension" />Switch on the Image Analyzer extension
...
## <a name="analyze-an-item-image" />Analyze an item image
...
## <a name="analyze-a-contact-person-picture" />Analyze a contact person picture
...
## <a name="stop-using-the-image-analyzer-extension" />Stop using the Image Analyzer extension
