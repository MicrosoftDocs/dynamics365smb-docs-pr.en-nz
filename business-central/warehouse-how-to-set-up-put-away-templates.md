...
ms.author: edupont
---
# <a name="set-up-put-away-templates" />Set Up Put-away Templates
...
## <a name="to-set-up-put-away-templates" />To set up put-away templates
...
## <a name="see-related-microsoft-trainingtrainingmodulesput-away-templates" />See related [Microsoft training](/training/modules/put-away-templates/)
