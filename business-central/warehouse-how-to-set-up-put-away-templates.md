...
ms.author: edupont
---
# <a name="set-up-put-away-templates"></a><a name="set-up-put-away-templates"></a>Set Up Put-away Templates
...
## <a name="to-set-up-put-away-templates"></a><a name="to-set-up-put-away-templates"></a>To set up put-away templates
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>See related [Microsoft training](/training/modules/put-away-templates/)
