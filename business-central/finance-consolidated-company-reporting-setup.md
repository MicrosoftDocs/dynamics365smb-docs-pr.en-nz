...
# <a name="set-up-company-consolidation" />Set Up Company Consolidation
...
## <a name="simple-consolidation-setup" />Simple consolidation setup
...
## <a name="advanced-consolidation-setup" />Advanced consolidation setup
...
### <a name="set-up-the-consolidated-company" />Set up the consolidated company
...
### <a name="a-namebusunitaadd-business-units" /><a name="busunit"></a>Add business units
...
### <a name="a-nameglaccaprepare-general-ledger-accounts-for-consolidation" /><a name="glacc"></a>Prepare general ledger accounts for consolidation
...
### <a name="a-nameexchratesaspecify-exchange-rates-for-consolidations" /><a name="exchrates"></a>Specify exchange rates for consolidations
...
### <a name="a-namedimainclude-or-exclude-dimensions" /><a name="dim"></a>Include or exclude dimensions
...
### <a name="a-nameexcludeaexclude-a-company-from-consolidation" /><a name="exclude"></a>Exclude a company from consolidation
...
### <a name="a-nameincludeainclude-a-partially-owned-company-in-consolidation" /><a name="include"></a>Include a partially-owned company in consolidation
