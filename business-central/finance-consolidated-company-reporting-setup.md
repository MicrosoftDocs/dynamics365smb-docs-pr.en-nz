...
# <a name="set-up-company-consolidation"></a><a name="set-up-company-consolidation"></a><a name="set-up-company-consolidation"></a>Set Up Company Consolidation
...
## <a name="simple-consolidation-setup"></a><a name="simple-consolidation-setup"></a><a name="simple-consolidation-setup"></a>Simple consolidation setup
...
## <a name="advanced-consolidation-setup"></a><a name="advanced-consolidation-setup"></a><a name="advanced-consolidation-setup"></a>Advanced consolidation setup
...
### <a name="set-up-the-consolidated-company"></a><a name="set-up-the-consolidated-company"></a><a name="set-up-the-consolidated-company"></a>Set up the consolidated company
...
### <a name="add-business-units"></a><a name="add-business-units"></a><a name="add-business-units"></a><a name="busunit"></a>Add business units
...
### <a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="glacc"></a>Prepare general ledger accounts for consolidation
...
### <a name="specify-exchange-rates-for-consolidations"></a><a name="specify-exchange-rates-for-consolidations"></a><a name="specify-exchange-rates-for-consolidations"></a><a name="exchrates"></a>Specify exchange rates for consolidations
...
### <a name="include-or-exclude-dimensions"></a><a name="include-or-exclude-dimensions"></a><a name="include-or-exclude-dimensions"></a><a name="dim"></a>Include or exclude dimensions
...
### <a name="exclude-a-company-from-consolidation"></a><a name="exclude-a-company-from-consolidation"></a><a name="exclude-a-company-from-consolidation"></a><a name="exclude"></a>Exclude a company from consolidation
...
### <a name="include-a-partially-owned-company-in-consolidation"></a><a name="include-a-partially-owned-company-in-consolidation"></a><a name="include-a-partially-owned-company-in-consolidation"></a><a name="include"></a>Include a partially-owned company in consolidation
