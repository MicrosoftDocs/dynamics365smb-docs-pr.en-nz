...
ms.author: edupont
---
# <a name="set-up-work-hours-and-service-hours" />Set Up Work Hours and Service Hours
...
## <a name="to-set-up-default-service-hours" />To set up default service hours
...
## <a name="to-set-up-work-hour-templates" />To set up work-hour templates
...
## <a name="to-set-up-contract-specific-service-hours" />To set up contract specific service hours
