...
ms.author: edupont
---
# <a name="correct-prepayments"></a><a name="correct-prepayments"></a>Correct Prepayments
...
## <a name="to-correct-a-prepayment"></a><a name="to-correct-a-prepayment"></a>To correct a prepayment
