...
---
# <a name="walkthrough-set-up-and-use-a-purchase-approval-workflow"></a>Walkthrough: Setting Up and Using a Purchase Approval Workflow
...
### <a name="set-up-approval-users"></a>Setting up approval users
...
### <a name="set-up-notifications"></a>Setting up notifications
...
#### <a name="to-set-up-how-and-when-youre-notified"></a>To set up how and when you are notified
...
## <a name="create-the-approval-workflow"></a>Creating the approval workflow
