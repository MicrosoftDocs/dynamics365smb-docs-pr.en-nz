...
---
# <a name="walkthrough-set-up-and-use-a-purchase-approval-workflow"></a>Walkthrough: Set up and use a purchase approval workflow
...
#### <a name="to-set-up-how-and-when-youre-notified"></a>To set up how and when you're notified
...
## <a name="create-the-approval-workflow"></a>Create the approval workflow
