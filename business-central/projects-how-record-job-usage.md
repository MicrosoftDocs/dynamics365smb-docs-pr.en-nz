...
---
# <a name="record-consumption-or-usage-for-projects"></a>Record Consumption or Usage for Jobs
...
## <a name="to-record-usage-for-a-project-planning-line-of-type-budget"></a>To record usage for a job planning line of type Budget
...
## <a name="to-create-project-journal-lines-manually"></a>To create job journal lines manually
...
## <a name="to-view-project-usage-estimates-and-post-updates"></a>To view job usage estimates and post updates
...
## <a name="create-inventory-and-warehouse-pick-documents-for-a-project"></a>Create inventory and warehouse pick documents for a job
...
## <a name="to-review-planning-lines-for-a-project-ledger-entry"></a>To review planning lines for a job ledger entry
