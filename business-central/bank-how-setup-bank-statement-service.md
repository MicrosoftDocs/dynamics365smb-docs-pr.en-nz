...
ms.author: edupont
---
# <a name="set-up-the-envestnet-yodlee-bank-feeds-service" />Set Up the Envestnet Yodlee Bank Feeds Service
...
## <a name="to-enable-the-bank-feed-service" />To enable the bank feed service
...
## <a name="to-create-a-new-linked-bank-account" />To create a new linked bank account
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Bank Accounts**, and then choose the related link.
...
## <a name="to-link-a-bank-account-to-an-online-bank-account" />To link a bank account to an online bank account
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Bank Accounts**, and then choose the related link.
...
## <a name="to-edit-the-credentials-for-an-online-bank-account" />To edit the credentials for an online bank account
1. Choose the ![Lightbulb that opens the Tell Me feature](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Bank Accounts**, and then choose the related link.  
...
## <a name="to-unlink-a-bank-account" />To unlink a bank account
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Bank Accounts**, and then choose the related link.  
...
## <a name="to-update-bank-account-linking" />To update bank account linking
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Bank Accounts**, and then choose the related link.
...
## <a name="to-enable-automatic-import-of-bank-statements" />To enable automatic import of bank statements
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Bank Accounts**, and then choose the related link.
