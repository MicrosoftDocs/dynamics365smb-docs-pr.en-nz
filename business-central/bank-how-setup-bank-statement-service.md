...
ms.author: edupont
---
# <a name="set-up-the-envestnet-yodlee-bank-feeds-service"></a><a name="set-up-the-envestnet-yodlee-bank-feeds-service"></a><a name="set-up-the-envestnet-yodlee-bank-feeds-service"></a>Set Up the Envestnet Yodlee Bank Feeds Service
...
## <a name="to-enable-the-bank-feed-service"></a><a name="to-enable-the-bank-feed-service"></a><a name="to-enable-the-bank-feed-service"></a>To enable the bank feed service
...
## <a name="to-create-a-new-linked-bank-account"></a><a name="to-create-a-new-linked-bank-account"></a><a name="to-create-a-new-linked-bank-account"></a>To create a new linked bank account
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Bank Accounts**, and then choose the related link.
...
## <a name="to-link-a-bank-account-to-an-online-bank-account"></a><a name="to-link-a-bank-account-to-an-online-bank-account"></a><a name="to-link-a-bank-account-to-an-online-bank-account"></a>To link a bank account to an online bank account
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Bank Accounts**, and then choose the related link.
...
## <a name="to-edit-the-credentials-for-an-online-bank-account"></a><a name="to-edit-the-credentials-for-an-online-bank-account"></a><a name="to-edit-the-credentials-for-an-online-bank-account"></a>To edit the credentials for an online bank account
1. Choose the ![Lightbulb that opens the Tell Me feature](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Bank Accounts**, and then choose the related link.  
...
## <a name="to-unlink-a-bank-account"></a><a name="to-unlink-a-bank-account"></a><a name="to-unlink-a-bank-account"></a>To unlink a bank account
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Bank Accounts**, and then choose the related link.  
...
## <a name="to-update-bank-account-linking"></a><a name="to-update-bank-account-linking"></a><a name="to-update-bank-account-linking"></a>To update bank account linking
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Bank Accounts**, and then choose the related link.
...
## <a name="to-enable-automatic-import-of-bank-statements"></a><a name="to-enable-automatic-import-of-bank-statements"></a><a name="to-enable-automatic-import-of-bank-statements"></a>To enable automatic import of bank statements
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Bank Accounts**, and then choose the related link.
