...
# <a name="business-central-and-microsoft-teams-integration" />Business Central and Microsoft Teams Integration
...
## <a name="features-overview" />Features overview

The [!INCLUDE [prod_short](includes/prod_short.md)] app for Teams offers the following features.

### <a name="look-up-details-of-customers-vendors-and-other-contacts" />Look up details of customers, vendors, and other contacts
...
### <a name="share-records-in-conversations" />Share records in conversations
...
### <a name="share-links-from-pages-in-business-central-to-teams" />Share links from pages in Business Central to Teams
...
### <a name="add-a-business-central-tab-to-teams-channel-or-chat" />Add a Business Central tab to Teams channel or chat
