...
ms.author: edupont
---
# <a name="transferring-and-posting-cost-entries" />Transferring and Posting Cost Entries
...
## <a name="criteria-for-transferring-general-ledger-entries-to-cost-entries" />Criteria for Transferring General Ledger Entries to Cost Entries
...
## <a name="transferring-general-ledger-entries-to-cost-entries" />Transferring General Ledger Entries to Cost Entries
...
### <a name="to-prepare-the-transfer" />To prepare the transfer
...
### <a name="to-transfer-general-ledger-entries-to-cost-entries" />To transfer general ledger entries to cost entries
...
## <a name="automatic-transfer-and-combined-entries" />Automatic Transfer and Combined Entries
...
## <a name="results-of-transferring-general-ledger-entries-to-cost-entries" />Results of Transferring General Ledger Entries to Cost Entries
...
### <a name="general-ledger-entries" />General Ledger Entries
...
### <a name="cost-entries" />Cost Entries
...
### <a name="cost-register" />Cost Register
...
## <a name="see-related-microsoft-trainingtrainingmodulestransfer-gl-entries-dynamics-365-business-central" />See related [Microsoft training](/training/modules/transfer-gl-entries-dynamics-365-business-central/)
