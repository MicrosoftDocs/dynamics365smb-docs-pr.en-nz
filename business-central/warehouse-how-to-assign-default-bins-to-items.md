...
ms.author: edupont
---
# <a name="assign-default-bins-to-items"></a><a name="assign-default-bins-to-items"></a><a name="assign-default-bins-to-items"></a>Assign Default Bins to Items
...
## <a name="to-assign-a-default-bin-to-an-item"></a><a name="to-assign-a-default-bin-to-an-item"></a><a name="to-assign-a-default-bin-to-an-item"></a>To assign a default bin to an item
...
## <a name="to-change-the-default-bin-for-an-item"></a><a name="to-change-the-default-bin-for-an-item"></a><a name="to-change-the-default-bin-for-an-item"></a>To change the default bin for an item
