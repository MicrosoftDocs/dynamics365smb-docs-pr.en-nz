...
ms.author: edupont
---
# <a name="assign-default-bins-to-items" />Assign Default Bins to Items
...
## <a name="to-assign-a-default-bin-to-an-item" />To assign a default bin to an item
...
## <a name="to-change-the-default-bin-for-an-item" />To change the default bin for an item
