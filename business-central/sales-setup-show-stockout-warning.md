...
# <a name="display-a-stockout-warning"></a>Display a stockout warning
...
## <a name="to-show-a-warning-about-low-inventory-on-a-sales-document"></a>To show a warning about low inventory on a sales document
