...
ms.author: jswymer
---
# <a name="optimizing-outlook-for-your-business-inbox"></a><a name="optimizing-outlook-for-your-business-inbox"></a>Optimising Outlook for Your Business Inbox
...
## <a name="update-outlook"></a><a name="update-outlook"></a>Update Outlook
...
### <a name="how-to-check-your-version-of-outlook"></a><a name="how-to-check-your-version-of-outlook"></a>How to check your version of Outlook
...
### <a name="how-to-update-outlook"></a><a name="how-to-update-outlook"></a>How to update Outlook
...
## <a name="install-microsoft-edge-webview2"></a><a name="install-microsoft-edge-webview2"></a>Install Microsoft Edge WebView2

Ensure that Microsoft Edge WebView2 is installed on your device.

### <a name="how-to-check-if-microsoft-edge-webview2-is-installed"></a><a name="how-to-check-if-microsoft-edge-webview2-is-installed"></a>How to check if Microsoft Edge WebView2 is installed
...
### <a name="how-to-install-microsoft-edge-webview2"></a><a name="how-to-install-microsoft-edge-webview2"></a>How to install Microsoft Edge WebView2
...
## <a name="use-a-supported-browser"></a><a name="use-a-supported-browser"></a>Use a supported browser
