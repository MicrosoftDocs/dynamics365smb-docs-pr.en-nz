...
ms.author: edupont
---
# <a name="legacy-update-custom-report-layouts" />(Legacy) Update Custom Report Layouts
...
## <a name="to-update-one-or-more-custom-report-layouts" />To update one or more custom report layouts
...
## <a name="to-test-custom-report-layout-updates" />To test custom report layout updates
...
## <a name="a-nameupdatelimitationsa-limitations-of-the-custom-report-layout-update" /><a name="UpdateLimitations"></a> Limitations of the Custom Report Layout Update
...
## <a name="a-namefixerrorsa-fixing-errors" /><a name="FixErrors"></a> Fixing Errors
