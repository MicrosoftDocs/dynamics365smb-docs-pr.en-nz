...
ms.author: jswymer
---
# <a name="use-the--apps-in-power-bi"></a><a name="use-the--apps-in-power-bi"></a>Use the [!INCLUDE [prod_short](includes/prod_short.md)] Apps in Power BI
...
## <a name="install-a--app-in-power-bi"></a><a name="install-a--app-in-power-bi"></a>Install a [!INCLUDE[prod_short](includes/prod_short.md)] app in Power BI
...
## <a name="connect-the--app-to-your-data"></a><a name="connect-the--app-to-your-data"></a>Connect the [!INCLUDE[prod_short](includes/prod_short.md)] app to your data
...
### <a name="you-dont-have-a-power-bi-account"></a><a name="you-dont-have-a-power-bi-account"></a>You don't have a Power BI account
...
### <a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a><a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a>Message: There are no enabled reports. Choose Select Report to see a list of reports that you can display.
...
### <a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a><a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a>You need a Power BI Pro licence to install the [!INCLUDE[prod_short](includes/prod_short.md)] app in Power BI
...
### <a name="parameter-validation-failed-please-make-sure-all-parameters-are-valid"></a><a name="parameter-validation-failed-please-make-sure-all-parameters-are-valid"></a>"Parameter validation failed, please make sure all parameters are valid"
...
### <a name="cant-sign-in"></a><a name="cant-sign-in"></a>Can't sign in
...
### <a name="incorrect-company-name"></a><a name="incorrect-company-name"></a>Incorrect company name
...
### <a name="the-key-didnt-match-any-rows-in-the-table"></a><a name="the-key-didnt-match-any-rows-in-the-table"></a>The key didn't match any rows in the table
...
### <a name="historical-data-appears-to-be-missing"></a><a name="historical-data-appears-to-be-missing"></a>Historical data appears to be missing
...
### <a name="i-only-see-data-for-a-single-company"></a><a name="i-only-see-data-for-a-single-company"></a>I only see data for a single company
...
### <a name="what-now"></a><a name="what-now"></a>What Now?
