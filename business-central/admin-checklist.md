...
ms.author: edupont
---
# <a name="onboard-users-with-checklists"></a><a name="onboard-users-with-checklists"></a>Onboard Users with Checklists
...
## <a name="to-add-an-item-to-the-checklist"></a><a name="to-add-an-item-to-the-checklist"></a>To add an item to the checklist
