...
ms.author: bholtorf
---
# <a name="the-quickbooks-payroll-file-import-extension" />The QuickBooks Payroll File Import Extension
...
## <a name="steps-to-import-payroll-data" />Steps to Import Payroll Data
