...
# <a name="couple-and-synchronize-records-between-dataverse-and-business-central"></a><a name="couple-and-synchronize-records-between-dataverse-and-business-central"></a>Couple and Synchronise Records between Dataverse and Business Central
...
## <a name="video-example"></a><a name="video-example"></a>Video Example
...
## <a name="to-couple-a-record"></a><a name="to-couple-a-record"></a>To couple a record
...
## <a name="to-synchronize-a-single-record"></a><a name="to-synchronize-a-single-record"></a>To synchronise a single record
...
## <a name="to-synchronize-a-single-record-from-"></a><a name="to-synchronize-a-single-record-from-"></a>To synchronise a single record from [!INCLUDE[crm_md](includes/crm_md.md)]
...
## <a name="to-couple-multiple-records-using-match-based-coupling"></a><a name="to-couple-multiple-records-using-match-based-coupling"></a>To couple multiple records using match-based coupling
...
## <a name="to-synchronize-multiple-records"></a><a name="to-synchronize-multiple-records"></a>To synchronise multiple records
...
## <a name="bulk-insert-and-couple-records"></a><a name="bulk-insert-and-couple-records"></a>Bulk-insert and couple records
...
## <a name="uncoupling-records"></a><a name="uncoupling-records"></a>Uncoupling Records
