...
ms.author: edupont
---
# <a name="add-extended-text" />Add Extended Text
...
## <a name="to-define-extended-text-for-an-description" />To define extended text for an description
...
## <a name="to-add-an-extended-item-text-on-a-sales-order-line" />To add an extended item text on a sales order line
