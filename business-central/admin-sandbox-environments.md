...
## <a name="advanced-user-experience" />Advanced user experience
...
### <a name="complete-sample-data" />Complete sample data
...
## <a name="see-related-microsoft-trainingtrainingmodulesadmin-online-dynamics--business-central" />See related [Microsoft training](/training/modules/admin-online-dynamics-365-business-central/)
