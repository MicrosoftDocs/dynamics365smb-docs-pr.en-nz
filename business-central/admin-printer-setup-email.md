...
---
# <a name="set-up-email-printers"></a><a name="set-up-email-printers"></a>Set up Email Printers
...
## <a name="add-an-email-printer"></a><a name="add-an-email-printer"></a>Add an email printer
