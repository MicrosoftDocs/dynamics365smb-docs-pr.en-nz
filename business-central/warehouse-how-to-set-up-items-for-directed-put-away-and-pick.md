...
ms.author: bholtorf
---
# <a name="set-up-items-and-locations-for-directed-put-away-and-pick" />Set Up Items and Locations for Directed Put-away and Pick
...
## <a name="to-set-up-an-item-for-directed-put-away-and-pick" />To set up an item for directed put-away and pick
...
## <a name="to-start-using-directed-put-away-and-pick" />To start using directed put-away and pick
...
## <a name="to-set-up-a-zone-in-your-warehouse" />To set up a zone in your warehouse
