...
ms.author: edupont
---
# <a name="reserve-items" />Reserve Items
...
## <a name="reserve-items-for-sales" />Reserve items for sales
...
## <a name="reserve-an-item-for-a-production-order-line" />Reserve an item for a production order line
...
## <a name="reserve-items-for-production-order-components" />Reserve items for production order components
...
## <a name="change-a-reservation" />Change a reservation
...
## <a name="cancel-a-reservation" />Cancel a reservation
...
## <a name="reserve-a-specific-serial-or-lot-number" />Reserve a specific serial or lot number
...
## <a name="see-related-microsoft-trainingtrainingmodulesmanage-outbound-serial-lot-numbers" />See related [Microsoft training](/training/modules/manage-outbound-serial-lot-numbers/)
