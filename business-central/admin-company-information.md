...
# <a name="company-information-overview" />Company Information Overview
...
## <a name="working-with-multiple-companies" />Working with multiple companies
...
## <a name="change-company-display-name" />Change company display name
