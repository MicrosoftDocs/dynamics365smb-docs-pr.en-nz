...
# <a name="control-access-to-business-central-using-security-groups" />Control Access to Business Central Using Security Groups
...
## <a name="business-central-online-and-on-premises" />Business Central online and on-premises
...
* For the online version, use Azure Active Directory security groups. To learn more about creating the group, go to [Create, edit, or delete a security group in the Microsoft 365 admin centre](/microsoft-365/admin/email/create-edit-or-delete-a-security-group).
...
## <a name="add-a-security-group-in-business-central" />Add a security group in Business Central
...
### <a name="assign-permissions-to-a-security-group" />Assign permissions to a security group
...
## <a name="review-the-permissions-in-a-security-group" />Review the permissions in a security group
...
## <a name="security-groups-and-user-groups" />Security groups and user groups
...
### <a name="optional-convert-user-groups-to-permission-sets" />Optional: Convert user groups to permission sets
