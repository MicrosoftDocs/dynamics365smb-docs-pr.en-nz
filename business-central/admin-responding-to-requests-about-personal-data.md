...
# <a name="responding-to-requests-about-users-personal-data"></a><a name="responding-to-requests-about-users-personal-data"></a>Responding to Requests About Users' Personal Data
...
## <a name="types-of-requests"></a><a name="types-of-requests"></a>Types of requests
...
## <a name="restrict-data-processing-for-a-data-subject"></a><a name="restrict-data-processing-for-a-data-subject"></a>Restrict data processing for a data subject
...
## <a name="handling-data-subject-requests-when-using-a-trial-version"></a><a name="handling-data-subject-requests-when-using-a-trial-version"></a>Handling data subject requests when using a trial version
...
## <a name="exporting-data-from-tables-not-classified-by-data-subject"></a><a name="exporting-data-from-tables-not-classified-by-data-subject"></a>Exporting data from tables not classified by data subject
...
## <a name="handling-data-about-minors"></a><a name="handling-data-about-minors"></a>Handling data about minors
