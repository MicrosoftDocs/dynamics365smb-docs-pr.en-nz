...
# <a name="responding-to-requests-about-users-personal-data" />Responding to Requests About Users' Personal Data
...
## <a name="types-of-requests" />Types of requests
...
## <a name="restrict-data-processing-for-a-data-subject" />Restrict data processing for a data subject
...
## <a name="handling-data-subject-requests-when-using-a-trial-version" />Handling data subject requests when using a trial version
...
## <a name="exporting-data-from-tables-not-classified-by-data-subject" />Exporting data from tables not classified by data subject
...
## <a name="handling-data-about-minors" />Handling data about minors
