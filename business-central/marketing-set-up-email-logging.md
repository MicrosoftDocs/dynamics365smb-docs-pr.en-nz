...
---
# <a name="track-email-message-exchanges-between-salespeople-and-contacts" />Track Email Message Exchanges Between Salespeople and Contacts
...
## <a name="to-set-up-email-logging" />To set up email logging

### <a name="set-up-public-folders-and-rules-for-email-logging-in-exchange-online" />Set up public folders and rules for email logging in Exchange Online

[!INCLUDE[admin-setup-email-public-folder](includes/admin-setup-email-public-folder.md)]

Next, you connect [!INCLUDE[prod_short](includes/prod_short.md)] with Exchange Online.

### <a name="set-up-a-shared-mailbox-and-rules-for-email-logging-in-exchange-online" />Set Up a shared mailbox and rules for email logging in Exchange Online
...
### <a name="add-a-user-account-for-members-of-the-shared-mailbox" />Add a user account for members of the shared mailbox
...
### <a name="allow-other-users-to-see-logged-emails" />Allow other users to see logged emails
...
### <a name="create-mail-flow-rules" />Create mail flow rules
...
## <a name="view-email-message-exchanges-in-the-interaction-log" />View email message exchanges in the Interaction Log
...
## <a name="mailbox-and-folder-limits-in-exchange-online" />Mailbox and folder limits in Exchange Online
...
## <a name="connect-on-premises-versions-to-microsoft-exchange" />Connect on-premises versions to Microsoft Exchange
...
-->
## <a name="connect-to-exchange-online" />Connect to Exchange Online
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-exchange-online" />To register an application in Azure AD for connecting from Business Central to Exchange Online
...
### <a name="use-another-identity-and-access-management-service" />Use Another Identity and Access Management Service
...
## <a name="to-start-logging-email" />To start logging email
...
## <a name="to-stop-logging-email" />To stop logging email
