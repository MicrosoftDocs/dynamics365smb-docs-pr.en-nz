...
### <a name="to-register-an-application-in-microsoft-entra-id-for-connecting-from-business-central-to-exchange-online"></a>To register an application in Microsoft Entra ID for connecting from Business Central to Exchange Online
