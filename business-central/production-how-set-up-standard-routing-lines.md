...
ms.author: edupont
---
# <a name="set-up-standard-routing-lines" />Set Up Standard Routing Lines
...
## <a name="to-set-up-a-standard-task" />To set up a standard task
...
## <a name="to-add-a-standard-task-to-an-operation" />To add a standard task to an operation
