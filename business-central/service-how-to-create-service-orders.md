...
ms.author: edupont
---
# <a name="create-service-orders" />Create Service Orders
...
## <a name="to-create-a-service-order" />To create a service order
...
## <a name="to-create-a-service-order-from-a-contract" />To create a service order from a contract
...
## <a name="to-convert-a-service-quote-to-a-service-order" />To convert a service quote to a service order
...
## <a name="to-check-item-availability-for-one-or-more-orders" />To check item availability for one or more orders
...
## <a name="to-reserve-an-item-for-a-service-order" />To reserve an item for a service order
...
## <a name="to-insert-lines-based-on-standard-service-codes" />To insert lines based on standard service codes
...
## <a name="to-register-internal-or-public-comments" />To register internal or public comments
...
## <a name="to-delete-invoiced-service-orders" />To delete invoiced service orders
