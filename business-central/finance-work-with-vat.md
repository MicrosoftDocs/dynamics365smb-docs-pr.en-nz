...
1. In the **General Ledger Setup** window, specify a **Max. GST Difference Allowed** between the amount calculated by the program and the manual amount.  
...
1. In the **General Ledger Setup** window, specify a **Max. GST Difference Allowed** between the amount calculated by the program and the manual amount.  
2. In the **General Journal Templates** window, choose the **Allow GST Difference** check box for the relevant journal.  
...
1. In the **Purchases & Payables Setup** window, choose the **Allow GST Difference** check box.  
