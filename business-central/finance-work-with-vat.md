...
ms.author: bholtorf
---
# <a name="work-with-vat-on-sales-and-purchases" />Work with GST on Sales and Purchases
...
## <a name="calculating-and-displaying-vat-amounts-on-sales-and-purchase-documents" />Calculating and displaying GST amounts on sales and purchase documents
...
### <a name="including-or-excluding-vat-in-prices-and-line-amounts" />Including or excluding GST in prices and line amounts
...
#### <a name="using-vat-business-posting-groups-and-customer-price-groups" />Using GST business posting groups and customer price groups
...
## <a name="working-with-vat-date" />Working with GST Date

### <a name="vat-date-in-documents" />GST Date in documents
...
### <a name="modifying-the-vat-date-in-posted-entries" />Modifying the GST Date in posted entries
...
## <a name="correcting-vat-amounts-manually-on-sales-and-purchase-documents" />Correcting GST amounts manually on sales and purchase documents
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-sales-documents" />To set the system up for manual GST entry in sales documents
...
### <a name="to-adjust-vat-for-a-sales-document" />To adjust GST for a sales document
...
## <a name="calculating-vat-manually-using-journals" />Calculating GST manually using journals
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-general-journals" />To set the system up for manual GST entry in a general journals
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-sales-and-purchase-journals" />To set the system up for manual GST entry in a sales and purchase journals
...
## <a name="posting-import-vat-with-purchase-invoices" />Posting Import GST with Purchase Invoices
Instead of using journals to post an import GST invoice, you can use a purchase invoice.  

### <a name="to-set-up-purchasing-for-posting-import-vat-invoices" />To set up purchasing for posting import GST invoices
