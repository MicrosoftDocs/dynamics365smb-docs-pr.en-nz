...
### <a name="correcting-vat-date-in-posted-entries"></a>Correcting GST Date in posted entries
In some situations it is necessary to change GST date even if the document has been posted and this is possible to be done in [!INCLUDE[prod_short](includes/prod_short.md)]. To change **GST Date** for posted documents you need to follow these steps:
...
3. Click **Edit list** action and enter the correct date in the **GST Date** field.
4. Close the page.
5. New GST date will be changed in related **G/L Entries** and in the posted document if exists.
