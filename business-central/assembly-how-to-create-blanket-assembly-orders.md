...
ms.author: edupont
---
# <a name="create-blanket-assembly-orders" />Create Blanket Assembly Orders
...
## <a name="to-create-a-blanket-assembly-order-for-an-assemble-to-order-item" />To create a blanket assembly order for an assemble\-to\-order item
