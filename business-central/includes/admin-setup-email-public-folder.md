...
### <a name="create-an-admin-role-group" />Create an admin role group
...
### <a name="create-a-new-public-folder-mailbox" />Create a new public folder mailbox
...
### <a name="create-new-public-folders" />Create new public folders
...
### <a name="set-public-folder-ownership" />Set public folder ownership
...
### <a name="mail-enable-the-queue-public-folder" />Mail-enable the *Queue* public folder
...
### <a name="mail-enable-sending-emails-to-the-queue-public-folder" />Mail-enable sending emails to the *Queue* public folder
