...
ms.author: bholtorf
---
# <a name="create-service-invoices-or-credit-memos" />Create Service Invoices or Credit Memos
...
## <a name="to-invoice-several-service-contracts" />To invoice several service contracts
...
## <a name="to-invoice-a-service-contract-from-the-service-contract-page" />To invoice a service contract from the Service Contract page
...
## <a name="to-post-an-invoice-from-a-service-order" />To post an invoice from a service order
...
## <a name="to-create-a-service-invoice-manually" />To create a service invoice manually
...
## <a name="to-create-an-invoice-that-combines-posted-shipment-lines-from-one-or-more-service-orders" />To create an invoice that combines posted shipment lines from one or more service orders
...
## <a name="to-create-a-service-credit-memo" />To create a service credit memo
