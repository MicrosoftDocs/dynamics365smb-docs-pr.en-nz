...
## <a name="to-create-a-production-bom-using-a-batch-unit-of-measure" />To create a production BOM using a batch unit of measure
...
## <a name="to-calculate-a-manufacturing-batch-unit-of-measure-on-a-production-order" />To calculate a manufacturing batch unit of measure on a production order
