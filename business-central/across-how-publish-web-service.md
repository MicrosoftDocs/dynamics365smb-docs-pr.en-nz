...
ms.author: edupont
---
# <a name="publish-a-web-service" />Publish a Web Service
...
## <a name="creating-and-publishing-a-web-service" />Creating and Publishing a Web Service

The following steps explain how to create and publish a web service.  

### <a name="to-create-and-publish-a-web-service" />To create and publish a web service
...
### <a name="to-verify-the-availability-of-a-web-service" />To verify the availability of a web service
