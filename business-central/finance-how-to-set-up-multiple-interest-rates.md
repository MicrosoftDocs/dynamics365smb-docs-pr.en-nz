...
ms.author: edupont
---
# <a name="set-up-multiple-interest-rates-for-delayed-payment" />Set Up Multiple Interest Rates for Delayed Payment
...
## <a name="to-set-up-multiple-interest-rates" />To set up multiple interest rates
