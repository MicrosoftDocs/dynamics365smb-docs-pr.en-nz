...
ms.author: edupont
---
# <a name="enter-external-document-numbers"></a><a name="enter-external-document-numbers"></a>Enter External Document Numbers
...
## <a name="to-enter-external-document-numbers-in-a-sales-order"></a><a name="to-enter-external-document-numbers-in-a-sales-order"></a>To enter external document numbers in a sales order
