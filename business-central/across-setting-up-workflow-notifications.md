...
ms.author: edupont
---
# <a name="approval-workflow-notifications"></a><a name="approval-workflow-notifications"></a>Approval Workflow Notifications
...
## <a name="set-up-notifications"></a><a name="set-up-notifications"></a>Set up notifications
