...
ms.author: jswymer
---
# <a name="change-basic-settings"></a><a name="change-basic-settings"></a>Change Basic Settings
...
## <a name="role"></a><a name="role"></a><a name="role-center"></a>Role
...
### <a name="change-the-role"></a><a name="change-the-role"></a>Change the role
...
## <a name="company"></a><a name="company"></a><a name="company"></a>Company
...
### <a name="work-date-indication"></a><a name="work-date-indication"></a>Work date indication
...
## <a name="language"></a><a name="language"></a><a name="language"></a> Language
...
## <a name="time-zone"></a><a name="time-zone"></a>Time zone
...
## <a name="teaching-tips"></a><a name="teaching-tips"></a>Teaching tips
