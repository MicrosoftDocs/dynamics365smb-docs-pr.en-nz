...
ms.author: edupont
---
# <a name="specify-posting-periods"></a><a name="specify-posting-periods"></a>Specify Posting Periods

Use posting periods to specify when users can post to the general ledger.  

## <a name="to-specify-posting-periods"></a><a name="to-specify-posting-periods"></a>To specify posting periods
