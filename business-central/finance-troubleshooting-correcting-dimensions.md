...
# <a name="troubleshoot-and-correct-dimensions"></a>Troubleshooting and correcting dimensions
...
### <a name="set-up-dimension-corrections"></a>Setting up dimension corrections
...
### <a name="correct-a-dimension"></a>Correcting a dimension
...
### <a name="validate-dimension-corrections"></a>Validating dimension corrections
...
### <a name="undo-a-correction"></a>Undoing a correction
...
### <a name="view-historical-dimension-corrections"></a>Viewing historical dimension corrections
...
### <a name="handle-incomplete-corrections"></a>Handling incomplete corrections
