...
# <a name="troubleshooting-and-correcting-dimensions"></a><a name="troubleshooting-and-correcting-dimensions"></a>Troubleshooting and Correcting Dimensions
...
## <a name="troubleshooting-dimensions-errors"></a><a name="troubleshooting-dimensions-errors"></a>Troubleshooting Dimensions Errors
...
## <a name="changing-dimension-assignments-after-posting"></a><a name="changing-dimension-assignments-after-posting"></a>Changing Dimension Assignments After Posting
...
### <a name="setting-up-dimension-corrections"></a><a name="setting-up-dimension-corrections"></a>Setting Up Dimension Corrections
...
### <a name="correcting-a-dimension"></a><a name="correcting-a-dimension"></a>Correcting a Dimension
...
### <a name="validating-dimension-corrections"></a><a name="validating-dimension-corrections"></a>Validating Dimension Corrections
...
### <a name="undoing-a-correction"></a><a name="undoing-a-correction"></a>Undoing a Correction
...
### <a name="dimension-corrections-on-large-data-sets"></a><a name="dimension-corrections-on-large-data-sets"></a>Dimension Corrections on Large Data Sets
...
### <a name="use-analysis-views-with-dimension-corrections"></a><a name="use-analysis-views-with-dimension-corrections"></a>Use Analysis Views with Dimension Corrections
...
### <a name="viewing-historical-dimension-corrections"></a><a name="viewing-historical-dimension-corrections"></a>Viewing Historical Dimension Corrections
...
### <a name="handling-incomplete-corrections"></a><a name="handling-incomplete-corrections"></a>Handling Incomplete Corrections
...
### <a name="use-cost-accounting-with-corrected-gl-entries"></a><a name="use-cost-accounting-with-corrected-gl-entries"></a>Use Cost Accounting with Corrected G/L Entries
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>See related [Microsoft training](/training/modules/dimensions-dynamics-365-business-central/)
