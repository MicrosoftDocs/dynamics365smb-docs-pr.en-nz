...
ms.author: edupont
---
# <a name="manage-job-supplies" />Manage Job Supplies
...
## <a name="to-purchase-items-or-services-for-a-job" />To purchase items or services for a job
...
## <a name="to-view-the-value-of-purchases-for-a-job" />To view the value of purchases for a job
...
## <a name="to-post-a-job-related-expense" />To post a job-related expense
