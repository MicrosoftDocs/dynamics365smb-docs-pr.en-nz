...
ms.author: edupont
---
# <a name="manage-job-supplies"></a><a name="manage-job-supplies"></a>Manage Job Supplies
...
## <a name="to-purchase-items-or-services-for-a-job"></a><a name="to-purchase-items-or-services-for-a-job"></a>To purchase items or services for a job
...
## <a name="to-view-the-value-of-purchases-for-a-job"></a><a name="to-view-the-value-of-purchases-for-a-job"></a>To view the value of purchases for a job
...
## <a name="to-post-a-job-related-expense"></a><a name="to-post-a-job-related-expense"></a>To post a job-related expense
