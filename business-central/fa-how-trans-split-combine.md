...
ms.author: edupont
---
# <a name="transfer-split-or-combine-fixed-assets" />Transfer, Split, or Combine Fixed Assets
...
## <a name="to-transfer-a-fixed-asset-to-a-different-department" />To transfer a fixed asset to a different department
...
## <a name="to-split-a-fixed-asset-into-three-fixed-assets" />To split a fixed asset into three fixed assets
...
## <a name="to-combine-two-fixed-assets-into-one" />To combine two fixed assets into one
...
## <a name="to-view-changed-depreciation-book-values-due-to-fixed-asset-reclassification" />To view changed depreciation book values due to fixed asset reclassification
...
## <a name="see-related-microsoft-trainingtrainingpathsreclassify-fixed-assets" />See related [Microsoft training](/training/paths/reclassify-fixed-assets/)
