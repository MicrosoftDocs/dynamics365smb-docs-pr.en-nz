...
---
# <a name="put-items-away-with-warehouse-put-aways" />Put Items Away with Warehouse Put-aways
...
## <a name="to-create-put-away-documents-in-bulk-with-the-put-away-worksheet" />To create put-away documents in bulk with the put-away worksheet
...
## <a name="to-create-a-put-away-from-a-posted-receipt" />To create a put-away from a posted receipt
...
## <a name="to-put-items-away" />To put items away
