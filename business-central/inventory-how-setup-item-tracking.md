...
ms.author: edupont
---
# <a name="set-up-item-tracking-with-serial-lot-and-package-numbers"></a><a name="set-up-item-tracking-with-serial-lot-and-package-numbers"></a>Set Up Item Tracking with Serial, Lot, and Package Numbers
...
## <a name="numbers-and-item-tracking"></a><a name="numbers-and-item-tracking"></a>Numbers and item tracking
...
## <a name="to-set-up-item-tracking-codes"></a><a name="to-set-up-item-tracking-codes"></a>To set up item tracking codes
...
## <a name="to-set-up-expiration-rules-for-serial-or-lot-numbers"></a><a name="to-set-up-expiration-rules-for-serial-or-lot-numbers"></a>To set up expiration rules for serial or lot numbers
...
## <a name="to-set-up-warranties-for-serial-or-lot-numbers"></a><a name="to-set-up-warranties-for-serial-or-lot-numbers"></a>To set up warranties for serial or lot numbers
...
## <a name="to-set-up-items-for-tracking-with-the-correct-item-tracking-codes"></a><a name="to-set-up-items-for-tracking-with-the-correct-item-tracking-codes"></a>To set up items for tracking with the correct item tracking codes
...
## <a name="to-specify-opening-balances-for-the-items-you-track"></a><a name="to-specify-opening-balances-for-the-items-you-track"></a>To specify opening balances for the items you track
...
### <a name="item-journals"></a><a name="item-journals"></a>Item journals
