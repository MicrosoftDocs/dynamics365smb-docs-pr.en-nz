...
---
# <a name="prepare-financial-reporting-with-financial-data-and-account-categories" />Prepare Financial Reporting with Financial Data and Account Categories
...
## <a name="financial-reports" />Financial reports
...
## <a name="gl-account-categories" />G/L account categories
...
## <a name="create-a-new-financial-report" />Create a new financial report
...
### <a name="edit-a-column-definition" />Edit a column definition
...
### <a name="create-a-column-that-calculates-percentages" />Create a column that calculates percentages
...
## <a name="set-up-financial-reports-with-overviews" />Set up financial reports with overviews
...
## <a name="comparing-accounting-periods-using-period-formulas" />Comparing accounting periods using period formulas
...
## <a name="print-and-save-financial-reports" />Print and save financial reports
...
### <a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document" />Schedule a financial report or save as a PDF, Word, or Excel document
...
## <a name="importing-or-exporting-financial-reports" />Importing or exporting financial reports
...
### <a name="import-and-export-financial-reports" />Import and export financial reports
...
## <a name="see-related-microsoft-trainingtrainingmodulesconfigure-financial-reports-dynamics--business-centralindex" />See related [Microsoft training](/training/modules/configure-financial-reports-dynamics-365-business-central/index).
