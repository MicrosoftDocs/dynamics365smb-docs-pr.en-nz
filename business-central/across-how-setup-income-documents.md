...
ms.author: edupont
---
# <a name="set-up-incoming-documents" />Set Up Incoming Documents
...
## <a name="to-set-up-the-incoming-documents-feature" />To set up the Incoming Documents feature
...
## <a name="to-set-up-approvers-of-incoming-document-records" />To set up approvers of incoming document records
...
## <a name="to-set-up-an-ocr-service" />To set up an OCR service
