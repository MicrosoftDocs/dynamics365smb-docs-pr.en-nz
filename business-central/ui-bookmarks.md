...
# <a name="bookmark-a-page-or-report-on-your-role-center" />Bookmark a Page or Report on Your Role Centre
...
## <a name="to-bookmark-the-target-page" />To bookmark the target page
...
## <a name="to-bookmark-the-target-report" />To bookmark the target report
...
## <a name="to-bookmark-a-page-or-report-from-the-tell-me-window" />To bookmark a page or report from the Tell Me window
