...
ms.author: edupont
---
# <a name="post-multiple-documents-at-the-same-time" />Post Multiple Documents at the Same Time
...
## <a name="to-post-multiple-purchase-orders-immediately" />To post multiple purchase orders immediately
...
## <a name="to-batch-post-multiple-purchase-orders" />To batch post multiple purchase orders
...
## <a name="to-set-up-background-posting-with-job-queues" />To set up background posting with job queues
...
### <a name="to-view-status-from-a-sales-or-purchase-document" />To view status from a sales or purchase document
...
## <a name="to-create-a-job-queue-entry-for-batch-posting-of-sales-orders" />To create a job queue entry for batch posting of sales orders
...
## <a name="monitor-the-job-queue" />Monitor the job queue
