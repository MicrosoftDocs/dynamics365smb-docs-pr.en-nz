...
ms.author: edupont
---
# <a name="use-allocation-keys-in-general-journals" />Use Allocation Keys in General Journals
...
## <a name="to-set-up-allocation-keys" />To set up allocation keys
...
## <a name="to-change-an-allocation-key-that-has-already-been-set-up" />To change an allocation key that has already been set up
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Recurring General Journal**, and then choose the related link.
