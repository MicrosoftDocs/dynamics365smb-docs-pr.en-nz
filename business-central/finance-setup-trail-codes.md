...
ms.author: edupont
---
# <a name="setting-up-source-codes-and-reason-codes-for-audit-trails" />Setting Up Source Codes and Reason Codes for Audit Trails
...
## <a name="define-source-codes" />Define source codes
...
### <a name="to-define-source-codes" />To define source codes
...
## <a name="change-source-codes" />Change source codes

You may want to change a source code. For example, you want to change the source code *GENJNL* to *GNJ*.

### <a name="to-change-source-codes" />To change source codes
...
## <a name="define-reason-codes" />Define reason codes
...
### <a name="to-set-up-reason-codes" />To set up reason codes
...
### <a name="to-assign-reason-codes-to-journal-templates" />To assign reason codes to journal templates
...
### <a name="to-use-reason-codes-on-sales-and-purchase-documents" />To use reason codes on sales and purchase documents
