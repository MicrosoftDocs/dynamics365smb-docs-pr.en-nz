...
# <a name="walkthrough-of-inbound-and-outbound-flow-in-mixed-warehouse-configurations" />Walkthrough of inbound and outbound flow in mixed Warehouse Configurations
...
## <a name="outbound-flow-picking-and-shipping-in-advanced-warehouse-configurations" />Outbound flow: Picking and Shipping in Advanced Warehouse Configurations
