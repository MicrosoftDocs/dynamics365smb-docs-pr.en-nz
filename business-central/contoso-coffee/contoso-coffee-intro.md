...
# <a name="introduction-to-contoso-coffee-demo-data" />Introduction to Contoso Coffee Demo Data
...
## <a name="set-up-contoso-coffee-data" />Set up Contoso Coffee data
...
## <a name="manufacturing-scenarios" />Manufacturing Scenarios
...
## <a name="warehousing-scenarios" />Warehousing Scenarios
