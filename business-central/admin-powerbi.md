...
---
# <a name="introduction-to-business-central-and-power-bi"></a>Introduction to [!INCLUDE[prod_short](includes/prod_short.md)] and Power BI
...
## <a name="what-you-can-do-with-power-bi-and-business-central"></a>What you can do with Power BI and [!INCLUDE[prod_short](includes/prod_short.md)]
