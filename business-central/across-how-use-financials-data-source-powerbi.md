...
## <a name="creating-accessible-reports" />Creating accessible reports
...
## <a name="creating-reports-to-display-data-associated-with-a-list" />Creating reports to display data associated with a list
...
### <a name="download-the-theme" />Download the theme
...
### <a name="import-the-theme-on-a-report" />Import the theme on a report
...
## <a name="publish-reports" />Publish reports
...
## <a name="distribute-or-share-a-report" />Distribute or share a report
...
### <a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page" />"Cannot insert a record. Current connection intent is Read-Only." error connecting to custom API page
