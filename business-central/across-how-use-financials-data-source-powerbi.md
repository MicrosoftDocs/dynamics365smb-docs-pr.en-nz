...
# <a name="building-power-bi-reports-to-display--data"></a><a name="building-power-bi-reports-to-display--data"></a>Building Power BI Reports to Display [!INCLUDE [prod_long](includes/prod_long.md)] Data
...
## <a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="getdata"></a>Add [!INCLUDE[prod_short](includes/prod_short.md)] as a data source in Power BI Desktop
...
## <a name="creating-accessible-reports"></a><a name="creating-accessible-reports"></a>Creating accessible reports
...
## <a name="creating-reports-to-display-data-associated-with-a-list"></a><a name="creating-reports-to-display-data-associated-with-a-list"></a>Creating reports to display data associated with a list
...
## <a name="using-the--report-theme-optional"></a><a name="using-the--report-theme-optional"></a><a name="theme"></a>Using the [!INCLUDE [prod_short](includes/prod_short.md)] report theme (optional)
...
### <a name="download-the-theme"></a><a name="download-the-theme"></a>Download the theme
...
### <a name="import-the-theme-on-a-report"></a><a name="import-the-theme-on-a-report"></a>Import the theme on a report
...
## <a name="publish-reports"></a><a name="publish-reports"></a>Publish reports
...
## <a name="distribute-or-share-a-report"></a><a name="distribute-or-share-a-report"></a>Distribute or share a report
...
### <a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a><a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a>"Cannot insert a record. Current connection intent is Read-Only." error connecting to custom API page
