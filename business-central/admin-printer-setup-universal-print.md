...
# <a name="set-up-universal-print-printers" />Set Up Universal Print Printers
...
## <a name="set-up-universal-print-and-printers-in-microsoft-azure" />Set up Universal Print and printers in Microsoft Azure
...
## <a name="add-printers-in-business-central-online" />Add printers in Business Central online
...
## <a name="add-printers-in-business-central-on-premises" />Add printers in Business Central on-premises
...
<!-- To Do Adding printers individually lets you duplicate printers with custom , like different paper trays and paper size and orientation.  To add printers individually, you'll need to know printer's share name in Universal Print. -->
### <a name="connect-to-universal-print-for-the-first-time" />Connect to Universal Print for the first-time
...
## <a name="common-problems-and-resolutions" />Common problems and resolutions
...
### <a name="you-dont-have-access-to-the-printer-your-printer" />You don't have access to the printer \<your-printer\>.
...
## <a name="there-was-an-error-fetching-printers-shared-to-you" />There was an error fetching printers shared to you.
