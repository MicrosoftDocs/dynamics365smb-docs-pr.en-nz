...
# View the Status of Synchronisation Jobs
...
## To view and resolve synchronisation errors for coupled records
...
## To view the synchronisation log for a specific (manually synchronised) record
