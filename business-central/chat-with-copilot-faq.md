...
## <a name="what-version-of-business-central-do-i-need-for-chat"></a>What version of Business Central do I need for chat?
...
- If you ask Copilot for an explanation or guidance, it doesn't have access to any information about your customisations or documentation for your add-ons.

## <a name="how-do-i-open-a-record-or-page-with-chat"></a>How do I open a record or page with chat?
...
## <a name="why-do-i-get-different-answers-from-copilot-for-the-same-question"></a>Why do I get different answers from Copilot for the same question?

Copilot might occasionally answer in different ways. Answers aren't always identical.

## <a name="how-do-i-use-the-copy-function-on-chat-messages"></a>How do I use the Copy function on chat messages?
...
## <a name="can-i-customize-or-extend-chat"></a>Can I customise or extend chat?
...
## <a name="does-copilot-search-for-data-in-other-companies-or-environments"></a>Does Copilot search for data in other companies or environments?
...
## <a name="what-can-i-do-if-the-chat-pane-doesnt-show"></a>What can I do if the chat pane doesn't show?

Check that your user language in **My Settings** is set to English, and that your environment is of version 24.0 or later. On the Copilot and AI Capabilities page, make sure the administrator has switched on consent for data across geographies and has activated chat. Also, make sure your environment localisation isn't Canada.

If you still don't see the chat with Copilot feature, it's possible that Microsoft is still rolling the feature out to your region. Copilot rolled out to US customers first in April 2024, and then over the course of weeks will roll out to other country/region localisations.
...
## <a name="why-does-copilot-give-incorrect-answers-to-calculations"></a>Why does Copilot give incorrect answers to calculations?
