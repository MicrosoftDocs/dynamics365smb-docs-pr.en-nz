...
ms.author: edupont
---
# <a name="set-up-shipment-methods"></a><a name="set-up-shipment-methods"></a><a name="set-up-shipment-methods"></a>Set Up Shipment Methods
...
## <a name="to-set-up-a-shipment-method"></a><a name="to-set-up-a-shipment-method"></a><a name="to-set-up-a-shipment-method"></a>To set up a shipment method
