...
ms.author: edupont
---
# <a name="define-user-tasks"></a><a name="define-user-tasks"></a>Define User Tasks
...
## <a name="managing-user-tasks"></a><a name="managing-user-tasks"></a>Managing User Tasks
...
### <a name="picking-up-user-tasks"></a><a name="picking-up-user-tasks"></a>Picking Up User Tasks
...
### <a name="deleting-user-tasks"></a><a name="deleting-user-tasks"></a>Deleting User Tasks
