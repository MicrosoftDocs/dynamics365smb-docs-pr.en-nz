...
ms.author: edupont
---
# <a name="define-user-tasks" />Define User Tasks
...
## <a name="managing-user-tasks" />Managing User Tasks
...
### <a name="picking-up-user-tasks" />Picking Up User Tasks
...
### <a name="deleting-user-tasks" />Deleting User Tasks
