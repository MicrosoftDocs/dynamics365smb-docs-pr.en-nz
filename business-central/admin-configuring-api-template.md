...
# <a name="configure-api-templates" />Configure API Templates
...
## <a name="setting-up-the-entity-template" />Setting up the Entity Template
...
## <a name="assign-the-template-to-an-api" />Assign the template to an API
