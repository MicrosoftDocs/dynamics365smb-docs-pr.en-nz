...
# <a name="configure-api-templates"></a><a name="configure-api-templates"></a>Configure API Templates
...
## <a name="setting-up-the-entity-template"></a><a name="setting-up-the-entity-template"></a>Setting up the Entity Template
...
## <a name="assign-the-template-to-an-api"></a><a name="assign-the-template-to-an-api"></a>Assign the template to an API
