...
ms.author: edupont
---
# <a name="invoice-jobs" />Invoice Jobs
...
## <a name="to-create-multiple-job-sales-invoices" />To create multiple job sales invoices
...
## <a name="to-create-and-post-job-sales-invoice-from-job-planning-lines" />To create and post job sales invoice from job planning lines
...
## <a name="see-related-microsoft-trainingtrainingpathspost-job-usage-sales" />See related [Microsoft training](/training/paths/post-job-usage-sales/)
