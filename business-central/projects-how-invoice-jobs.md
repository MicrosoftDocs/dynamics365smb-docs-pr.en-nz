...
---
# <a name="invoice-projects"></a>Invoice Jobs
...
## <a name="to-create-multiple-project-sales-invoices"></a>To create multiple job sales invoices
...
## <a name="to-create-and-post-project-sales-invoice-from-project-planning-lines"></a>To create and post job sales invoice from job planning lines
