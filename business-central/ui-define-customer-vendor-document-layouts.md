...
## <a name="to-specify-which-contact-receives-which-document-layout-for-a-customer"></a>To specify which contact receives which document layout for a customer
