...
ms.author: edupont
---
# <a name="define-document-layouts-for-customers-and-vendors" />Define Document Layouts for Customers and Vendors
...
## <a name="to-load-the-standard-document-layouts-for-sales-documents-for-a-customer" />To load the standard document layouts for sales documents for a customer
...
## <a name="to-select-a-custom-report-layout-to-use-for-the-sales-document-layout" />To select a custom report layout to use for the sales document layout
...
## <a name="to-specify-which-contact-will-receive-which-document-layout-for-a-customer" />To specify which contact will receive which document layout for a customer
