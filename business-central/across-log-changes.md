...
## <a name="monitor-sensitive-fields"></a>Monitoring Sensitive Fields
...
### <a name="set-up-field-monitoring"></a>Setting Up Field Monitoring
...
### <a name="view-field-monitoring-telemetry"></a>Viewing Field Monitoring Telemetry
...
## <a name="define-retention-policies"></a>Defining Retention Policies
