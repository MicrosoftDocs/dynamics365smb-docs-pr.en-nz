...
ms.author: edupont
---
# <a name="auditing-changes-in-business-central"></a><a name="auditing-changes-in-business-central"></a><a name="auditing-changes-in-business-central"></a>Auditing Changes in Business Central
...
## <a name="about-the-change-log"></a><a name="about-the-change-log"></a><a name="about-the-change-log"></a>About the Change Log
...
### <a name="work-with-the-change-log"></a><a name="work-with-the-change-log"></a><a name="work-with-the-change-log"></a>Work with the Change Log
...
## <a name="about-activity-logs"></a><a name="about-activity-logs"></a><a name="about-activity-logs"></a>About Activity Logs
...
### <a name="work-with-activity-logs"></a><a name="work-with-activity-logs"></a><a name="work-with-activity-logs"></a>Work with Activity Logs
...
## <a name="monitoring-sensitive-fields"></a><a name="monitoring-sensitive-fields"></a><a name="monitoring-sensitive-fields"></a>Monitoring Sensitive Fields
...
### <a name="setting-up-field-monitoring"></a><a name="setting-up-field-monitoring"></a><a name="setting-up-field-monitoring"></a>Setting Up Field Monitoring
...
### <a name="work-with-field-monitoring"></a><a name="work-with-field-monitoring"></a><a name="work-with-field-monitoring"></a>Work with Field Monitoring
...
### <a name="viewing-field-monitoring-telemetry"></a><a name="viewing-field-monitoring-telemetry"></a><a name="viewing-field-monitoring-telemetry"></a>Viewing Field Monitoring Telemetry
...
## <a name="defining-retention-policies"></a><a name="defining-retention-policies"></a><a name="defining-retention-policies"></a>Defining Retention Policies
