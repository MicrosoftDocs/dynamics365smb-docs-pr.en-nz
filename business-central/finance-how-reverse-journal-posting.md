...
---
# <a name="reverse-journal-postings-and-undo-receiptsshipments" />Reverse Journal Postings and Undo Receipts/Shipments
...
## <a name="to-reverse-the-journal-posting-of-a-general-ledger-entry" />To reverse the journal posting of a general ledger entry
...
## <a name="to-post-a-negative-entry" />To post a negative entry
...
## <a name="to-undo-a-quantity-on-a-posted-purchase-receipt" />To undo a quantity on a posted purchase receipt
...
## <a name="to-undo-and-then-redo-a-quantity-posting-on-a-posted-return-shipment" />To undo and then redo a quantity posting on a posted return shipment
