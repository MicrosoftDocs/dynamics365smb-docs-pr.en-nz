...
---
# <a name="sell-assemble-to-order-items-and-inventory-items-together" />Sell Assemble-to-Order Items and Inventory Items Together
...
## <a name="to-sell-assemble-to-order-items-and-inventory-items-together" />To sell assemble-to-order items and inventory items together
