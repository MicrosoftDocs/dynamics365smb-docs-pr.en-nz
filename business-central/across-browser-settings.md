...
ms.author: jswymer
---
# <a name="setting-up-and-troubleshooting-your-browser-to-work-with-business-central-web-client" />Setting Up and Troubleshooting Your Browser to Work With Business Central Web Client
...
## <a name="allow-javascript-from-business-central" />Allow JavaScript from Business Central
...
## <a name="allow-cookies-from-business-central" />Allow cookies from Business Central
