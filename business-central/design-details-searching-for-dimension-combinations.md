...
ms.author: edupont
---
# <a name="design-details-searching-for-dimension-combinations" />Design Details: Searching for Dimension Combinations
...
### <a name="finding-dimension-set-id" />Finding Dimension Set ID
