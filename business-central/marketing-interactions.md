...
ms.author: jswymer
---
# <a name="record-interactions-with-contacts"></a><a name="record-interactions-with-contacts"></a><a name="record-interactions-with-contacts"></a>Record Interactions With Contacts
...
## <a name="setting-up-interaction-templates"></a><a name="setting-up-interaction-templates"></a><a name="setting-up-interaction-templates"></a>Setting up Interaction Templates
...
## <a name="creating-interactions"></a><a name="creating-interactions"></a><a name="creating-interactions"></a>Creating Interactions
...
## <a name="viewing-and-managing-recorded-interactions"></a><a name="viewing-and-managing-recorded-interactions"></a><a name="viewing-and-managing-recorded-interactions"></a>Viewing and Managing Recorded Interactions
