...
ms.author: edupont
---
# <a name="multiple-contracts" />Multiple Contracts
...
## <a name="creating-multiple-contracts-per-service-item" />Creating Multiple Contracts per Service Item
...
## <a name="copying-documents" />Copying Documents
...
## <a name="creating-service-orders-for-multiple-contracts" />Creating Service Orders for Multiple Contracts
