...
# <a name="get-started-with-a-business-central-preview-version-for-copilot"></a><a name="get-started-with-a-business-central-preview-version-for-copilot"></a>Get started with a Business Central preview version for Copilot
...
## <a name="your-organization-already-uses-business-central"></a><a name="your-organization-already-uses-business-central"></a>Your organisation already uses Business Central
...
## <a name="your-organization-doesnt-use-business-central"></a><a name="your-organization-doesnt-use-business-central"></a>Your organisation doesn't use Business Central
