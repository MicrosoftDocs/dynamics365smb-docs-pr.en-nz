...
ms.author: bholtorf
---
# <a name="allocation-status-and-repair-status-of-service-items" />Allocation Status and Repair Status of Service Items
...
## <a name="changing-repair-status" />Changing Repair Status
...
## <a name="converting-service-quotes-to-service-orders" />Converting Service Quotes to Service Orders
...
## <a name="canceling-allocations" />Cancelling Allocations
...
## <a name="reallocating-an-active-allocation-entry" />Reallocating an Active Allocation Entry
...
## <a name="reallocating-a-service-item" />Reallocating a Service Item
