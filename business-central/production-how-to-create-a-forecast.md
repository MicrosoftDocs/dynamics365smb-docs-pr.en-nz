...
ms.author: edupont
---
# <a name="create-a-demand-forecast"></a><a name="create-a-demand-forecast"></a>Create a Demand Forecast
...
## <a name="sales-forecasts-and-production-forecasts"></a><a name="sales-forecasts-and-production-forecasts"></a>Sales Forecasts and Production Forecasts
...
## <a name="component-forecast"></a><a name="component-forecast"></a>Component Forecast
...
## <a name="forecasting-periods"></a><a name="forecasting-periods"></a>Forecasting Periods
...
## <a name="forecast-by-locations"></a><a name="forecast-by-locations"></a>Forecast by Locations
...
### <a name="use-forecast-by-locations"></a><a name="use-forecast-by-locations"></a>Use forecast by locations
...
### <a name="do-not-use-forecast-by-locations"></a><a name="do-not-use-forecast-by-locations"></a>Do not use forecast by locations
...
## <a name="to-create-a-demand-forecast"></a><a name="to-create-a-demand-forecast"></a>To create a demand forecast
