...
ms.author: edupont
---
# <a name="create-a-demand-forecast" />Create a Demand Forecast
...
## <a name="sales-forecasts-and-production-forecasts" />Sales Forecasts and Production Forecasts
...
## <a name="component-forecast" />Component Forecast
...
## <a name="forecasting-periods" />Forecasting Periods
...
## <a name="forecast-by-locations" />Forecast by Locations
...
### <a name="use-forecast-by-locations" />Use forecast by locations
...
### <a name="do-not-use-forecast-by-locations" />Do not use forecast by locations
...
## <a name="to-create-a-demand-forecast" />To create a demand forecast
