...
ms.author: edupont
---
# <a name="setup-best-practices-reordering-policies" />Setup Best Practices: Reordering Policies
...
## <a name="see-related-microsoft-trainingtrainingpathsreplenish-items-dynamics-365-business-central" />See related [Microsoft training](/training/paths/replenish-items-dynamics-365-business-central/)
