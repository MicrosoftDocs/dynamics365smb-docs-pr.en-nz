...
ms.author: edupont
---
# <a name="track-relations-between-demand-and-supply" />Track Relations Between Demand and Supply
...
## <a name="to-track-linked-items" />To track linked items
...
## <a name="untracked-planning-elements" />Untracked Planning Elements
