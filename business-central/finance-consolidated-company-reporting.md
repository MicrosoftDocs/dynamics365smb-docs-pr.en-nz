...
# <a name="consolidating-financial-data-from-multiple-companies"></a><a name="consolidating-financial-data-from-multiple-companies"></a>Consolidating Financial Data from Multiple Companies
...
## <a name="use-the-consolidated-trial-balance-report"></a><a name="use-the-consolidated-trial-balance-report"></a>Use the Consolidated Trial Balance report
...
## <a name="consolidate-data"></a><a name="consolidate-data"></a>Consolidate data
...
### <a name="to-test-the-data-before-you-consolidate"></a><a name="to-test-the-data-before-you-consolidate"></a>To test the data before you consolidate
...
### <a name="run-the-consolidation"></a><a name="run-the-consolidation"></a>Run the consolidation
...
## <a name="eliminate-repeated-transactions"></a><a name="eliminate-repeated-transactions"></a>Eliminate repeated transactions
...
## <a name="export-and-import-consolidated-data-between-databases"></a><a name="export-and-import-consolidated-data-between-databases"></a>Export and import consolidated data between databases
