...
# <a name="consolidating-financial-data-from-multiple-companies" />Consolidating Financial Data from Multiple Companies
...
## <a name="use-the-consolidated-trial-balance-report" />Use the Consolidated Trial Balance report
...
## <a name="consolidate-data" />Consolidate data
...
### <a name="to-test-the-data-before-you-consolidate" />To test the data before you consolidate
...
### <a name="run-the-consolidation" />Run the consolidation
...
## <a name="eliminate-repeated-transactions" />Eliminate repeated transactions
...
## <a name="export-and-import-consolidated-data-between-databases" />Export and import consolidated data between databases
