...
# <a name="setting-up-troubleshooting-for-service-items" />Setting Up Troubleshooting for Service Items
...
## <a name="to-set-up-troubleshooting-guidelines" />To set up troubleshooting guidelines
...
## <a name="to-assign-troubleshooting-guidelines-to-items-service-items-or-service-item-groups" />To assign troubleshooting guidelines to items, service items, or service item groups
