...
ms.author: edupont
---
# <a name="set-up-finance-charge-terms" />Set Up Finance Charge Terms
...
## <a name="finance-charge-terms" />Finance charge terms
...
### <a name="to-set-up-finance-charge-terms" />To set up finance charge terms
...
## <a name="see-related-microsoft-training" />See related [Microsoft training](/training/modules/send-memos-dynamics-365-business-central/)
