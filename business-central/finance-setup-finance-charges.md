...
ms.author: edupont
---
# <a name="set-up-finance-charge-terms"></a><a name="set-up-finance-charge-terms"></a>Set Up Finance Charge Terms
...
## <a name="finance-charge-terms"></a><a name="finance-charge-terms"></a>Finance charge terms
...
### <a name="to-set-up-finance-charge-terms"></a><a name="to-set-up-finance-charge-terms"></a>To set up finance charge terms
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>See related [Microsoft training](/training/modules/send-memos-dynamics-365-business-central/)
