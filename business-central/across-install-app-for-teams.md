...
# <a name="install-the--app-for-microsoft-teams"></a><a name="install-the--app-for-microsoft-teams"></a>Install the [!INCLUDE [prod_short](includes/prod_short.md)] App for Microsoft Teams
...
## <a name="add-the-business-central-app-to-teams"></a><a name="add-the-business-central-app-to-teams"></a>Add the Business Central app to Teams
...
## <a name="next-step"></a><a name="next-step"></a>Next step
