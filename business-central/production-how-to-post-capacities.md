...
ms.author: edupont
---
# <a name="post-capacities"></a><a name="post-capacities"></a>Post Capacities
...
## <a name="to-post-capacities"></a><a name="to-post-capacities"></a>To post capacities
...
## <a name="to-view-work-center-ledger-entries"></a><a name="to-view-work-center-ledger-entries"></a>To view work centre ledger entries
