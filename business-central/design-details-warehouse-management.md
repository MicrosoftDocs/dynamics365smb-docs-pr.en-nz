...
# <a name="warehouse-management-overview" />Warehouse Management Overview
...
## <a name="modeling-the-physical-warehouse" />Modelling the physical warehouse
...
### <a name="locations-and-bins" />Locations and bins
...
### <a name="shelves-and-bins" />Shelves and bins
...
## <a name="typical-warehouse-workflow" />Typical warehouse workflow
...
## <a name="terminology-related-to-warehouse-management" />Terminology related to warehouse management

### <a name="complexity-levels" />Complexity levels
...
### <a name="warehouse-flows" />Warehouse flows
...
### <a name="basic-documents" />Basic documents
...
### <a name="advanced-documents" />Advanced documents
...
### <a name="pages-and-settings" />Pages and settings

This section describes the concepts behind the key pages and settings for warehousing.

#### <a name="bins-and-bin-content" />Bins and Bin Content
...
#### <a name="warehouse-class" />Warehouse Class
