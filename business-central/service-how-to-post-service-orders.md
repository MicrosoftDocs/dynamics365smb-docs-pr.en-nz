...
ms.author: edupont
---
# <a name="post-service-orders-and-credit-memos"></a><a name="post-service-orders-and-credit-memos"></a><a name="post-service-orders-and-credit-memos"></a>Post Service Orders and Credit Memos
...
## <a name="to-post-a-service-order"></a><a name="to-post-a-service-order"></a><a name="to-post-a-service-order"></a>To post a service order
...
## <a name="to-batch-post-service-orders"></a><a name="to-batch-post-service-orders"></a><a name="to-batch-post-service-orders"></a>To batch post service orders
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Service Orders**, and then choose the related link.  
...
## <a name="to-post-a-service-credit-memo"></a><a name="to-post-a-service-credit-memo"></a><a name="to-post-a-service-credit-memo"></a>To post a service credit memo
...
## <a name="to-post-consumption-from-a-service-order"></a><a name="to-post-consumption-from-a-service-order"></a><a name="to-post-consumption-from-a-service-order"></a>To post consumption from a service order
...
## <a name="to-post-shipments-from-service-orders"></a><a name="to-post-shipments-from-service-orders"></a><a name="to-post-shipments-from-service-orders"></a>To post shipments from service orders
...
## <a name="to-undo-posted-consumption"></a><a name="to-undo-posted-consumption"></a><a name="to-undo-posted-consumption"></a>To undo posted consumption
...
## <a name="to-post-service-lines"></a><a name="to-post-service-lines"></a><a name="to-post-service-lines"></a>To post service lines
