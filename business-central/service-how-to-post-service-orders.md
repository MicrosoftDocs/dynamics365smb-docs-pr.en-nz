...
ms.author: edupont
---
# <a name="post-service-orders-and-credit-memos" />Post Service Orders and Credit Memos
...
## <a name="to-post-a-service-order" />To post a service order
...
## <a name="to-batch-post-service-orders" />To batch post service orders
1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Service Orders**, and then choose the related link.  
...
## <a name="to-post-a-service-credit-memo" />To post a service credit memo
...
## <a name="to-post-consumption-from-a-service-order" />To post consumption from a service order
...
## <a name="to-post-shipments-from-service-orders" />To post shipments from service orders
...
## <a name="to-undo-posted-consumption" />To undo posted consumption
...
## <a name="to-post-service-lines" />To post service lines
