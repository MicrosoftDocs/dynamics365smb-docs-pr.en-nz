...
---
# <a name="power-bi-integration-component-and-architecture-overview"></a>Power BI Integration Component and Architecture Overview for [!INCLUDE[prod_short](includes/prod_short.md)]
