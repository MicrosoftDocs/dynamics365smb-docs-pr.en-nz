...
ms.author: jswymer
---
# <a name="power-bi-integration-component-and-architecture-overview-for-"></a><a name="power-bi-integration-component-and-architecture-overview-for-"></a><a name="power-bi-integration-component-and-architecture-overview-for-"></a>Power BI Integration Component and Architecture Overview for [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="components"></a><a name="components"></a><a name="components"></a>Components
...
## <a name="whats-available-from-the-start"></a><a name="whats-available-from-the-start"></a><a name="whats-available-from-the-start"></a>What's available from the start
...
## <a name="general-flow"></a><a name="general-flow"></a><a name="general-flow"></a>General Flow
