...
# <a name="set-up-fault-reporting" />Set Up Fault Reporting
...
## <a name="to-specify-the-overall-level-of-fault-reporting" />To specify the overall level of fault reporting
...
## <a name="to-create-fault-and-resolution-code-relationships" />To create fault and resolution code relationships
