...
# <a name="add-marketing-text-to-items" />Add marketing text to items
...
## <a name="a-namecopilotacreate-ai-generated-marketing-text-preview-with-copilot" /><a name=copilot></a>Create AI-generated marketing text (preview) with Copilot
...
### <a name="create-first-draft-with-copilot" />Create first draft with Copilot
...
### <a name="review-edit-and-save-text" />Review, edit, and save text
...
### <a name="improve-and-tailor-text-suggestions" />Improve and tailor text suggestions
...
## <a name="create-marketing-text-from-scratch" />Create marketing text from scratch
