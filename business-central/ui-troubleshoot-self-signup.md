...
ms.author: edupont
---
# <a name="troubleshooting-self-service-sign-up"></a><a name="troubleshooting-self-service-sign-up"></a>Troubleshooting Self-Service Sign-Up
...
## <a name="what-email-address-can-i-use-with-business-central"></a><a name="what-email-address-can-i-use-with-business-central"></a>What email address can I use with Business Central?
...
## <a name="regional-availability"></a><a name="regional-availability"></a>Regional Availability
