...
ms.author: jswymer
---
# <a name="add-contacts-to-segments" />Add Contacts to Segments
...
## <a name="to-add-a-contact-to-a-segment" />To add a contact to a segment
...
## <a name="to-refine-the-number-of-contacts" />To refine the number of contacts
...
## <a name="to-reduce-the-number-of-contacts" />To reduce the number of contacts
