...
ms.author: edupont
---
# <a name="enable-customer-payments-through-payment-services" />Enable Customer Payments Through Payment Services
...
## <a name="to-select-a-payment-service-on-a-sales-invoice" />To select a payment service on a sales invoice
