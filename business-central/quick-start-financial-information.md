...
# <a name="financial-information-quick-start" />Financial Information Quick Start
...
## <a name="set-up-the-chart-of-accounts" />Set up the chart of accounts
...
### <a name="add-an-account-to-the-chart-of-accounts" />Add an account to the chart of accounts
...
### <a name="get-an-overview-of-the-chart-of-accounts" />Get an overview of the chart of accounts
...
## <a name="see-related-training-at-microsoft-learnlearnpathsset-up-financial-management-dynamics--business-central" />See related training at [Microsoft Learn](/learn/paths/set-up-financial-management-dynamics-365-business-central/).
