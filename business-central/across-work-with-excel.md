...
ms.author: jswymer
---
# <a name="viewing-and-editing-in-excel-from-business-central"></a><a name="viewing-and-editing-in-excel-from-business-central"></a>Viewing and Editing in Excel From Business Central
...
## <a name="open-in-excel"></a><a name="open-in-excel"></a>Open in Excel
...
## <a name="edit-in-excel"></a><a name="edit-in-excel"></a>Edit in Excel
...
### <a name="first-time-sign-in"></a><a name="first-time-sign-in"></a>First-time sign-in
...
### <a name="work-across-environments-and-companies"></a><a name="work-across-environments-and-companies"></a>Work across environments and companies
...
### <a name="limits-when-using-excel-for-the-web"></a><a name="limits-when-using-excel-for-the-web"></a>Limits when using Excel for the web
...
## <a name="see-the-differences-between-the-options"></a><a name="see-the-differences-between-the-options"></a>See the differences between the options
<br><br>  
